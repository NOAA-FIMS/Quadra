...
./inspect_bigeye_level9_geometry.sh

echo
echo "== O3 build Bigeye Level 9 geometry =="
...
c++ -std=c++17 -O3 \
  ...
  -o build/examples/pifsc_bigeye_level9_geometry_check

echo
echo "== Run Bigeye Level 9 geometry =="
./build/examples/pifsc_bigeye_level9_geometry_check
