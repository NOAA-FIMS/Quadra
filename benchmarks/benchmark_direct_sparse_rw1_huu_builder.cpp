...
Result run_case(int m, int reps) {
    ...
    quadra::laplace::SparseLaplaceExactGradientEvaluationInputs direct_sparse_inputs;
    ...
    out.dense_to_sparse_ms = mean_ms([&]() {
        ...
        inputs.theta = theta;
        inputs.uhat = uhat;
        inputs.Huu = quadra::laplace::dense_to_sparse(Huu_dense(theta, uhat), 0.0);
...
int main(int argc, char** argv) {
    ...
    std::cout << std::setw(8) << "m"
              ...
              << std::setw(22) << "dense->sparse ms"
              << std::setw(20) << "direct sparse ms"
              << std::setw(18) << "dir/dense spd"
              << std::setw(20) << "dir/convert spd"
    ...
    for (int m : dims) {
        ...
        std::cout << std::setw(8) << m
                  ...
                  << std::setw(22) << r.dense_to_sparse_ms
                  << std::setw(20) << r.direct_sparse_ms
                  << std::setw(18) << r.direct_speedup_vs_dense
                  << std::setw(20) << r.direct_speedup_vs_convert
