...
EvalResult evaluate_active_set(int m,
                               int reps,
...
Row run_case(int m, int reps) {
    ...
    const auto no_mu =
        evaluate_active_set(m, reps, std::vector<int>{1, 2, 3, 4});
    ...
    out.structural_diff = (all.gradient - structural.gradient).cwiseAbs().maxCoeff();
...
int main(int argc, char** argv) {
    ...
    std::cout << "theta = [mu, log_sigma, log_lambda0, log_lambda_rw, log_beta]\n\n";

    std::cout << std::setw(8) << "m"
              << std::setw(14) << "all ms"
              << std::setw(14) << "no_mu ms"
              << std::setw(16) << "struct ms"
              << std::setw(14) << "no_mu spd"
              << std::setw(14) << "struct spd"
              << std::setw(16) << "no_mu diff"
              << std::setw(16) << "struct diff"
              << "\n";
    ...
    for (int m : dims) {
        ...
        std::cout << std::setw(8) << m
                  << std::setw(14) << r.all_ms
                  << std::setw(14) << r.no_mu_ms
                  << std::setw(16) << r.structural_ms
                  << std::setw(14) << r.no_mu_speedup
                  << std::setw(14) << r.structural_speedup
                  << std::setw(16) << r.no_mu_diff
                  << std::setw(16) << r.structural_diff
                  << "\n";
    }
