...
Row run_case(int n, int K, int reps) {
  ...
  for (int k = 0; k < K; ++k) {
    out.max_abs_diff =
        std::max(out.max_abs_diff, std::abs(scalar_ref[static_cast<size_t>(k)] -
...
int main(int argc, char **argv) {
  ...
  std::cout << std::setw(8) << "n" << std::setw(8) << "K" << std::setw(16)
            << "scalar ms" << std::setw(16) << "batch ms" << std::setw(14)
            << "speedup" << std::setw(16) << "max diff" << "\n";
  ...
  for (int n : n_values) {
    for (int K : K_values) {
      ...
      std::cout << std::setw(8) << n << std::setw(8) << K << std::setw(16)
                << r.scalar_ms << std::setw(16) << r.batch_ms << std::setw(14)
                << r.speedup << std::setw(16) << r.max_abs_diff << "\n";
    }
  }
