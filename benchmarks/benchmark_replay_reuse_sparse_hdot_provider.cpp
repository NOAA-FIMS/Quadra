...
Result run_case(int m, int reps) {
  ...
  Result out;
  out.max_abs_diff = (g_active - g_reuse).cwiseAbs().maxCoeff();
  ...
  out.active_speedup = out.baseline_ms / out.active_ms;
  out.reuse_speedup = out.baseline_ms / out.replay_reuse_ms;
  return out;
}
...
int main(int argc, char **argv) {
  ...
  std::cout << "Replay-reuse sparse exact Hdot benchmark\n";
  std::cout << "reps per case = " << reps << "\n\n";

  std::cout << std::setw(8) << "m" << std::setw(18) << "baseline ms"
            << std::setw(18) << "active ms" << std::setw(18) << "reuse ms"
            << std::setw(16) << "active spd" << std::setw(16) << "reuse spd"
            << std::setw(18) << "active-reuse" << "\n";
  ...
  for (int m : dims) {
    ...
    std::cout << std::setw(8) << m << std::setw(18) << r.baseline_ms
              << std::setw(18) << r.active_ms << std::setw(18)
              << r.replay_reuse_ms << std::setw(16) << r.active_speedup
              << std::setw(16) << r.reuse_speedup << std::setw(18)
              << r.max_abs_diff << "\n";
  }
