...
int main(int argc, char **argv) {
  ...
  std::cout << std::setw(8) << "m" << std::setw(12) << "vertices"
            << std::setw(12) << "entries" << std::setw(14) << "graph"
            << std::setw(14) << "seed" << std::setw(14) << "reverse"
            << std::setw(14) << "extract" << std::setw(14) << "total"
            << std::setw(12) << "rev%" << std::setw(12) << "ext%" << "\n";
  ...
  for (int m : m_values) {
    ...
    std::cout << std::setw(8) << m << std::setw(12) << avg.vertices
              << std::setw(12) << avg.extract_entries << std::setw(14)
              << avg.graph_build_ms << std::setw(14) << avg.seed_ms
              << std::setw(14) << avg.reverse_ms << std::setw(14)
              << avg.extract_ms << std::setw(14) << avg.total_ms
