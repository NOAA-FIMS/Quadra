...
EvalResult rebuild_eval(const std::vector<double> &y, double mu_value,
                        double u_value) {
  ...
  Eigen::VectorXd g = quadra::extract_gradient(std::vector<quadra::AD>{mu, u});
...
int main() {
  ...
  std::cout << std::setw(8) << "n" << std::setw(12) << "evals" << std::setw(18)
            << "rebuild ms" << std::setw(18) << "reuse ms" << std::setw(14)
            << "speedup" << std::setw(18) << "final grad_mu" << std::setw(18)
            << "final grad_u" << "\n";
  ...
  for (size_t n : std::vector<size_t>{10, 100, 1000, 5000, 10000}) {
    ...
    std::cout << std::setw(8) << n << std::setw(12) << n_evals << std::setw(18)
              << std::fixed << std::setprecision(3) << rebuild_ms
              << std::setw(18) << reuse_ms << std::setw(14) << speedup
              << std::setw(18) << reuse_last.grad_mu_m << std::setw(18)
              << reuse_last.grad_u_m << "\n";
  }
