...
Result run_case(int m, int reps) {
    ...
    out.repeated_gradient_ms = mean_ms([&]() {
        // Different envelope gradient to make sure the call still does real work,
        // but reuses the cached logdet contribution.
...
int main(int argc, char** argv) {
    ...
    std::cout << std::setw(8) << "m"
              << std::setw(22) << "first gradient ms"
              << std::setw(24) << "repeated gradient ms"
              << std::setw(16) << "speedup"
              << "\n";
    ...
    for (int m : dims) {
        ...
        std::cout << std::setw(8) << m
                  << std::setw(22) << r.first_gradient_ms
                  << std::setw(24) << r.repeated_gradient_ms
