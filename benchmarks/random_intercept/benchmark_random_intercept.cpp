...
int main()
{
    std::ofstream csv("benchmarks/random_intercept/random_intercept_benchmark.csv");
    ...
    csv << "n_obs,workspace_ms,implicit_derivatives_ms,factorization_ms,total_wall_ms,success\n";
    ...
    std::cout << "wrote benchmarks/random_intercept/random_intercept_benchmark.csv\n";
