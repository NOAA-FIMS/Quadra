...
Result run_case(int m, int reps) {
  ...
  out.max_abs_diff = std::max(std::abs(dense_ref - selected_ref),
...
int main(int argc, char **argv) {
  ...
  std::cout << std::setw(8) << "m" << std::setw(14) << "needed cols"
            << std::setw(18) << "dense RHS ms" << std::setw(20) << "selected ms"
            << std::setw(18) << "cached ms" << std::setw(18) << "selected spd"
            << std::setw(16) << "cached spd" << std::setw(16) << "max diff"
            << "\n";
  ...
  for (int m : dims) {
    ...
    std::cout << std::setw(8) << m << std::setw(14) << r.needed_cols
              << std::setw(18) << r.dense_rhs_ms << std::setw(20)
              << r.selected_cols_ms << std::setw(18) << r.cached_cols_ms
              << std::setw(18) << r.selected_speedup << std::setw(16)
              << r.cached_speedup << std::setw(16) << r.max_abs_diff << "\n";
  }
