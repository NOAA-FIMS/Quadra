...
int main() {
    ...
    std::cout
        << std::setw(8)  << "n"
        << std::setw(18) << "FD LBFGS ms"
        << std::setw(14) << "FD iter"
        << std::setw(18) << "Exact LBFGS ms"
        << std::setw(14) << "Exact iter"
    ...
    for (size_t n : std::vector<size_t>{10, 100, 1000, 5000, 10000}) {
        ...
        std::cout
            << std::setw(8) << n
            << std::setw(18) << std::fixed << std::setprecision(3) << fd_ms
            << std::setw(14) << fd_result.iterations_m
            << std::setw(18) << exact_ms
            << std::setw(14) << exact_result.iterations_m
            << std::setw(18) << exact_result.theta_hat_m[0]
            << std::setw(18) << exact_result.u_hat_m[0]
            << "\n";
    }
