...
int main(int argc, char** argv) {
    ...
    std::cout << std::setw(8) << "m"
              << std::setw(14) << "build"
              << std::setw(14) << "factor"
              << std::setw(16) << "impl solve"
              << std::setw(14) << "Hdot"
              << std::setw(14) << "trace"
              << std::setw(14) << "full"
              << std::setw(14) << "Hdot/full"
              << std::setw(14) << "trace/full"
              << "\n";
    ...
    for (int m : dims) {
        ...
        std::cout << std::setw(8) << m
                  << std::setw(14) << r.build_ms
                  << std::setw(14) << r.factor_ms
                  << std::setw(16) << r.implicit_solve_ms
                  << std::setw(14) << r.hdot_ms
                  << std::setw(14) << r.trace_ms
                  << std::setw(14) << r.full_eval_ms
                  << std::setw(14) << r.hdot_fraction
                  << std::setw(14) << r.trace_fraction
                  << "\n";
    }
