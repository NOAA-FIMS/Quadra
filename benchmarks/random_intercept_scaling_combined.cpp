...
int main() {
  ...
  std::cout << std::setw(8) << "n" << std::setw(18) << "Exact old ms"
            << std::setw(14) << "Old iter" << std::setw(20) << "Combined ms"
            << std::setw(14) << "Comb iter" << std::setw(18) << "theta_hat"
            << std::setw(18) << "u_hat" << "\n";
  ...
  for (size_t n : std::vector<size_t>{10, 100, 1000, 5000, 10000}) {
    ...
    double old_ms = time_ms([&]() {
      old_result = quadra::optimize_laplace_fixed_effects_exact_lbfgs(
    ...
    std::cout << std::setw(8) << n << std::setw(18) << std::fixed
              << std::setprecision(3) << old_ms << std::setw(14)
              << old_result.iterations_m << std::setw(20) << combined_ms
              << std::setw(14) << combined_result.iterations_m << std::setw(18)
              << combined_result.theta_hat_m[0] << std::setw(18)
              << combined_result.u_hat_m[0] << "\n";
  }
