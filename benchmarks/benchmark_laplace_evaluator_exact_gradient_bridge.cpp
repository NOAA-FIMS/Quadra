...
int main(int argc, char** argv) {
    ...
    std::cout << "LaplaceEvaluatorExactGradientBridge benchmark\n";
    std::cout << "reps per case = " << reps << "\n\n";

    std::cout << std::setw(8) << "m"
              << std::setw(18) << "eval ms"
              << std::setw(18) << "objective"
              << std::setw(18) << "grad norm"
              << "\n";
    ...
    for (int m : dims) {
        ...
        std::cout << std::setw(8) << m
                  << std::setw(18) << r.bridge_eval_ms
                  << std::setw(18) << r.objective
                  << std::setw(18) << r.grad_norm
                  << "\n";
    }
