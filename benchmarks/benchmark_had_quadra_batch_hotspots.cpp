...
Row run_case(int n, int K, int reps) {
...

  {
    ...
    out.scalar_query_ms = mean_ms([&]() { return checksum_scalar(b); }, reps);
  }
...

  {
    ...
    out.batch_query_ms = mean_ms([&]() { return checksum_batch(b, K); }, reps);
  }
...
int main(int argc, char **argv) {
  ...
  std::cout << std::setw(8) << "n" << std::setw(8) << "K" << std::setw(14)
            << "build" << std::setw(14) << "s_prop" << std::setw(14)
            << "s_query" << std::setw(14) << "b_prop" << std::setw(14)
            << "b_query" << std::setw(14) << "prop spd" << "\n";
  ...
  for (int n : n_values) {
    for (int K : K_values) {
      ...
      std::cout << std::setw(8) << n << std::setw(8) << K << std::setw(14)
                << r.build_adj_ms << std::setw(14) << r.scalar_prop_ms
                << std::setw(14) << r.scalar_query_ms << std::setw(14)
                << r.batch_prop_ms << std::setw(14) << r.batch_query_ms
