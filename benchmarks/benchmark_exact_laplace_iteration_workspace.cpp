...
Result run_case(int m, int reps) {
    ...
    out.workspace_gradient_ms = mean_ms([&]() {
...
int main(int argc, char** argv) {
    ...
    std::cout << std::setw(8) << "m"
              << std::setw(20) << "construct ms"
              << std::setw(20) << "gradient ms"
    ...
    for (int m : dims) {
        ...
        std::cout << std::setw(8) << m
                  << std::setw(20) << r.workspace_construct_ms
                  << std::setw(20) << r.workspace_gradient_ms
                  << std::setw(18) << r.total_ms
                  << "\n";
    }
