...
int main(int argc, char** argv) {
    ...
    std::cout << std::setw(8) << "m"
              << std::setw(12) << "pattern"
              << std::setw(20) << "Hdot all dirs ms"
              << std::setw(20) << "trace all dirs ms"
              << std::setw(20) << "full grad ms"
              << std::setw(16) << "Hdot/full"
              << std::setw(16) << "trace/full"
              << "\n";
    ...
    for (int m : dims) {
        ...
        std::cout << std::setw(8) << m
                  ...
                  << std::setw(20) << r.hdot_all_dirs_ms
                  << std::setw(20) << r.trace_all_dirs_ms
                  << std::setw(20) << r.full_gradient_ms
                  << std::setw(16) << r.hdot_fraction
                  << std::setw(16) << r.trace_fraction
                  << "\n";
    }
