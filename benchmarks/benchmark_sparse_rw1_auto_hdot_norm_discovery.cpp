...
int main(int argc, char** argv) {
    ...
    std::cout << "Sparse RW1 auto Hdot-norm active-direction discovery benchmark\n";
    std::cout << "reps per case = " << reps << "\n\n";

    for (double tol : tolerances) {
        std::cout << "tolerance = " << std::scientific << std::setprecision(1) << tol << "\n";

        std::cout << std::setw(8) << "m"
                  << std::setw(10) << "active"
                  << std::setw(16) << "discover"
                  << std::setw(14) << "eval"
                  << std::setw(14) << "total"
                  << std::setw(14) << "eval spd"
                  << std::setw(14) << "total spd"
                  << std::setw(16) << "max diff"
                  << std::setw(14) << "min norm"
                  << std::setw(14) << "max norm"
                  << "\n";
        ...
        for (int m : dims) {
            ...
            std::cout << std::setw(8) << m
                      << std::setw(10) << r.active_count
                      << std::setw(16) << r.discovery_ms
                      << std::setw(14) << r.eval_ms
                      << std::setw(14) << r.total_ms
                      << std::setw(14) << r.speedup_eval_only
                      << std::setw(14) << r.speedup_including_discovery
                      << std::setw(16) << r.max_abs_diff
                      << std::setw(14) << r.min_norm
