...
int main() {
    ...
    std::cout
        ...
        << std::setw(10) << "m"
        << std::setw(12) << "evals"
        << std::setw(18) << "functional ms"
        << std::setw(18) << "evaluator ms"
        << std::setw(14) << "speedup"
        << std::setw(14) << "nnz Huu"
        << "\n";
    ...
    for (int G : std::vector<int>{25, 50, 100, 250, 500}) {
        ...
        std::cout
            ...
            << std::setw(10) << m
            << std::setw(12) << evals
            << std::setw(18) << std::fixed << std::setprecision(3) << functional_ms
            << std::setw(18) << evaluator_ms
            << std::setw(14) << speedup
            << std::setw(14) << evaluator_last.hessian_random_m.nonZeros()
            << "\n";
    }
