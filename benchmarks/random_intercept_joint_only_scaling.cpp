...
int main() {
    ...
    std::cout
        << std::setw(8)  << "n"
        << std::setw(20) << "Full exact ms"
        << std::setw(14) << "Full iter"
        << std::setw(20) << "Joint only ms"
        << std::setw(14) << "Joint iter"
    ...
    for (size_t n : std::vector<size_t>{10, 100, 1000, 5000, 10000}) {
        ...
        std::cout
            << std::setw(8) << n
            << std::setw(20) << std::fixed << std::setprecision(3) << full_ms
            << std::setw(14) << full_result.iterations_m
            << std::setw(20) << joint_ms
            << std::setw(14) << joint_result.iterations_m
            << std::setw(16) << joint_result.theta_hat_m[0]
            << std::setw(16) << joint_result.u_hat_m[0]
            << "\n";
    }
