...
int main() {
    ...
    std::cout
        << std::setw(8)  << "n"
        << std::setw(16) << "Newton ms"
        << std::setw(16) << "Hessian ms"
        << std::setw(18) << "LaplaceObj ms"
        << std::setw(18) << "ExactGrad ms"
        << std::setw(18) << "ExactLBFGS ms"
    ...
    for (size_t n : std::vector<size_t>{10, 100, 1000, 5000, 10000}) {
        ...
        std::cout
            << std::setw(8) << n
            << std::setw(16) << std::fixed << std::setprecision(3) << components.random_newton_ms_m
            ...
            << std::setw(18) << optimizer.exact_lbfgs_ms_m
            << std::setw(14) << optimizer.exact_lbfgs_iterations_m
            << std::setw(16) << optimizer.theta_hat_m
            << std::setw(16) << optimizer.u_hat_m
            << "\n";
    }
