...
echo "== Repair Opakapaka Level-1 reporting inspector runner =="

cat > inspect_opakapaka_level1_reporting_v4.sh <<'SH'
#!/usr/bin/env bash
set -euo pipefail
...
if [[ -x ./run_opakapaka_projection.sh ]]; then
...
chmod +x inspect_opakapaka_level1_reporting_v4.sh

echo "Run:"
echo "  ./inspect_opakapaka_level1_reporting_v4.sh"
