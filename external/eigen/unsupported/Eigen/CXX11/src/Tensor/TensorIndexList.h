...
template <Index Idx, typename ValueT> struct tuple_coeff {
  ...
  value_known_statically(const Index i, const IndexTuple<T...> &t) {
    return ((i == Idx) &
...
template <typename ValueT> struct tuple_coeff<0, ValueT> {
  ...
  template <typename... T>
  EIGEN_DEVICE_FUNC static constexpr bool
  value_known_statically(const Index i, const IndexTuple<T...> &) {
    return is_compile_time_constant<
...
struct IndexList : internal::IndexTuple<FirstType, OtherTypes...> {
  EIGEN_STRONG_INLINE EIGEN_DEVICE_FUNC constexpr Index
...
struct IndexPairList : internal::IndexTuple<FirstType, OtherTypes...> {
  EIGEN_STRONG_INLINE EIGEN_DEVICE_FUNC constexpr IndexPair<Index>
  operator[](const Index i) const {
    return internal::tuple_coeff<internal::array_size<internal::IndexTuple<
                                     FirstType, OtherTypes...>>::value -
                                     1,
