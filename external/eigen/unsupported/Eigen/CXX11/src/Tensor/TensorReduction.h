...
struct FullReducer {
  ...
  run(const Self &self, Op &reducer, const Device &,
...
FullReductionKernel(R, const S, I_, typename S::CoeffReturnType *,
                    unsigned int *);
...
template <int B, int N, typename S, typename R, typename I_>
__global__ EIGEN_HIP_LAUNCH_BOUNDS_1024 void
FullReductionKernelHalfFloat(R, const S, I_, half *,
                             internal::packet_traits<half>::type *);
...
private:
  ...
  template <int B, int N, typename S, typename R, typename I_>
  KERNEL_FRIEND void
  internal::FullReductionKernel(R, const S, I_, typename S::CoeffReturnType *,
                                unsigned int *);
#if defined(EIGEN_HAS_GPU_FP16)
  template <typename S, typename R, typename I_>
  ...
  template <int NPT, typename S, typename R, typename I_>
  KERNEL_FRIEND void
  internal::InnerReductionKernel(R, const S, I_, I_,
                                 typename S::CoeffReturnType *);

  template <int NPT, typename S, typename R, typename I_>
  KERNEL_FRIEND void
  internal::OuterReductionKernel(R, const S, I_, I_,
                                 typename S::CoeffReturnType *);
#endif
...
struct TensorEvaluator<const TensorReductionOp<Op, Dims, ArgType, MakePointer_>,
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE typename Base::CoeffReturnType
  ...
  template <int LoadMode>
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE typename Base::PacketReturnType
  packet(typename Base::Index index) const {
