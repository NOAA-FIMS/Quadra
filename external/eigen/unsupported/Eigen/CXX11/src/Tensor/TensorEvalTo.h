...
struct TensorEvaluator<const TensorEvalToOp<ArgType, MakePointer_>, Device> {
  ...
  EIGEN_STRONG_INLINE TensorEvaluator(const XprType &op, const Device &device)
      : m_impl(op.expression(), device), m_buffer(device.get(op.buffer())),
  ...
  evalSubExprsIfNeededAsync(EvaluatorPointerType scalar,
  ...
  evalBlock(TensorBlockDesc &desc, TensorBlockScratch &scratch) {
