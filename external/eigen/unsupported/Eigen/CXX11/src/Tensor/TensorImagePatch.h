...
template <typename Self, bool Vectorizable> struct ImagePatchCopyOp {
  typedef typename Self::Index Index;
  typedef typename Self::Scalar Scalar;
  typedef typename Self::Impl Impl;
  static EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void
  Run(const Self &self, const Index num_coeff_to_copy, const Index dst_index,
...
template <typename Self> struct ImagePatchCopyOp<Self, true> {
  typedef typename Self::Index Index;
  typedef typename Self::Scalar Scalar;
  typedef typename Self::Impl Impl;
...
template <typename Self> struct ImagePatchPaddingOp {
  typedef typename Self::Index Index;
  typedef typename Self::Scalar Scalar;
  typedef typename packet_traits<Scalar>::type Packet;
  static EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void
  Run(const Index num_coeff_to_pad, const Scalar padding_value,
...
struct TensorEvaluator<const TensorImagePatchOp<Rows, Cols, ArgType>, Device> {
  ...
  evalSubExprsIfNeededAsync(EvaluatorPointerType, EvalSubExprsCallback done) {
