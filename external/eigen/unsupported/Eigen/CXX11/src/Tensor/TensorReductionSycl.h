...
public:
  ...
  FullReductionKernelFunctor(LocalAccessor scratch_, Evaluator evaluator_,
                             ...
                             OpType op_)
      : scratch(scratch_), evaluator(evaluator_), final_output(final_output_),
        rng(rng_), op(OpDef::get_op(op_)) {}
...
public:
  ...
  GenericNondeterministicReducer(Scratch, Evaluator evaluator_,
      ...
      : evaluator(evaluator_), output_accessor(output_accessor_),
        functor(OpDef::get_op(functor_)), range(range_),
...
struct PartialReductionKernel {
  ...
  PartialReductionKernel(ScratchAcc scratch_, Evaluator evaluator_,
      ...
      : scratch(scratch_), evaluator(evaluator_),
        output_accessor(output_accessor_), op(OpDef::get_op(op_)),
  ...
  element_wise_reduce(Index globalRId, Index globalPId,
...
struct SecondStepPartialReduction {
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE SecondStepPartialReduction(
      ...
      : input_accessor(input_accessor_), output_accessor(output_accessor_),
        op(OpDef::get_op(op_)), num_coeffs_to_preserve(num_coeffs_to_preserve_),
        num_coeffs_to_reduce(num_coeffs_to_reduce_) {}
