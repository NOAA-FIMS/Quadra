 ...
 */
template <typename Scalar> struct scalar_igamma_der_a_op {
 ...
 */
template <typename Scalar> struct scalar_gamma_sample_der_alpha_op {
...
template <typename Scalar> struct functor_traits<scalar_ndtri_op<Scalar>> {
  enum {
