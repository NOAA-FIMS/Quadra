...
template <typename> static void test_static_reshape() {
  ...
  Tensor<float, 3> reshaped =
      tensor.reshape(static_cast<Eigen::DSizes<ptrdiff_t, 3>>(dim));
...
template <typename T, int DataLayout> static void test_simple_slice() {
...
template <typename T> static void test_const_slice() {
  const T b[1] = {42};
...
template <typename T, int DataLayout> static void test_slice_in_expr() {
...
template <typename T, int DataLayout> static void test_slice_as_lvalue() {
...
template <typename T, int DataLayout> static void test_slice_raw_data() {
...
template <typename T, int DataLayout> static void test_strided_slice() {
...
template <typename T, int DataLayout> static void test_strided_slice_write() {
  typedef Tensor<T, 2, DataLayout> Tensor2f;
  typedef Eigen::DSizes<Eigen::DenseIndex, 2> Index2;
...
template <typename T, int DataLayout> static void test_composition() {
...
template <typename T, int DataLayout> static void test_empty_slice() {
