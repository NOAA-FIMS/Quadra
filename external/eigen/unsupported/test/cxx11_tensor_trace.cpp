...
template <int DataLayout> static void test_0D_trace() {
...
template <int DataLayout> static void test_all_dimensions_trace() {
...
template <int DataLayout> static void test_simple_trace() {
