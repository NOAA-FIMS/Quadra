...
static_assert(std::is_trivially_move_assignable<DenseStorageD3x3>::value,
              "DenseStorage not trivially_move_assignable");
...
static_assert(std::is_trivially_copy_assignable<DenseStorageD3x3>::value,
              "DenseStorage not trivially_copy_assignable");
static_assert(std::is_trivially_copyable<DenseStorageD3x3>::value,
              "DenseStorage not trivially_copyable");
#endif
#endif
...
template <typename T> void dense_storage_tests() {
  // Dynamic Storage.
