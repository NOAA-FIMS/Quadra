...
template <typename Scalar> struct TestMethodDispatching<Scalar, 1> {
  static void run() {
    {
...
template <typename Scalar> void fixedsizeVariadicVectorConstruction() {
  CALL_SUBTEST((fixedsizeVariadicVectorConstruction2<Matrix<Scalar, 4, 1>,
                                                     Matrix<Scalar, 5, 1>>()));
  CALL_SUBTEST((fixedsizeVariadicVectorConstruction2<Matrix<Scalar, 1, 4>,
                                                     Matrix<Scalar, 1, 5>>()));
  CALL_SUBTEST((fixedsizeVariadicVectorConstruction2<Array<Scalar, 4, 1>,
                                                     Array<Scalar, 5, 1>>()));
  CALL_SUBTEST((fixedsizeVariadicVectorConstruction2<Array<Scalar, 1, 4>,
                                                     Array<Scalar, 1, 5>>()));
}
...
template <typename Scalar> void initializerListVectorConstruction() {
  ...
  }
  {
    ...
    VERIFY_IS_EQUAL(
        m, (Matrix<Scalar, 4, 1>({{raw[0]}, {raw[1]}, {raw[2]}, {raw[3]}})));
    VERIFY(
        (a == (Array<Scalar, 4, 1>({{raw[0]}, {raw[1]}, {raw[2]}, {raw[3]}})))
            .all());
  }
  {
    ...
    VERIFY_IS_EQUAL(m,
                    (Matrix<Scalar, 1, 4>({{raw[0], raw[1], raw[2], raw[3]}})));
    VERIFY(
        (a == (Array<Scalar, 1, 4>({{raw[0], raw[1], raw[2], raw[3]}}))).all());
  }
  {
    ...
    VERIFY_IS_EQUAL(m, (Matrix<Scalar, 4, Dynamic>(
                           {{raw[0]}, {raw[1]}, {raw[2]}, {raw[3]}})));
    VERIFY((a == (Array<Scalar, 4, Dynamic>(
                     {{raw[0]}, {raw[1]}, {raw[2]}, {raw[3]}})))
               .all());
  }
  {
    ...
    VERIFY_IS_EQUAL(
        m, (Matrix<Scalar, Dynamic, 4>({{raw[0], raw[1], raw[2], raw[3]}})));
    VERIFY(
        (a == (Array<Scalar, Dynamic, 4>({{raw[0], raw[1], raw[2], raw[3]}})))
            .all());
  }
}
...
template <typename Scalar> void initializerListMatrixConstruction() {
  ...
  }
  {
    ...
    m2 << raw[0], raw[1], raw[2], raw[3], raw[4], raw[5], raw[6], raw[7],
