...
template <typename T> void test_roundtrip() {
  // Representable T round trip via bfloat16
  VERIFY_IS_EQUAL((internal::cast<bfloat16, T>(internal::cast<T, bfloat16>(
  ...
  VERIFY_IS_EQUAL((internal::cast<bfloat16, T>(internal::cast<T, bfloat16>(
                  ...
                  std::numeric_limits<T>::infinity());
  VERIFY_IS_EQUAL(
      (internal::cast<bfloat16, T>(internal::cast<T, bfloat16>(T(-1.0)))),
      T(-1.0));
  VERIFY_IS_EQUAL(
      (internal::cast<bfloat16, T>(internal::cast<T, bfloat16>(T(-0.5)))),
      T(-0.5));
  VERIFY_IS_EQUAL(
      (internal::cast<bfloat16, T>(internal::cast<T, bfloat16>(T(-0.0)))),
      T(-0.0));
  VERIFY_IS_EQUAL(
      (internal::cast<bfloat16, T>(internal::cast<T, bfloat16>(T(1.0)))),
      T(1.0));
...
void test_conversion() {
  ...
  // Epsilon
  VERIFY_LE(1.0f,
            static_cast<float>((std::numeric_limits<bfloat16>::epsilon)() +
                               bfloat16(1.0f)));
  VERIFY_IS_EQUAL(
      1.0f, static_cast<float>((std::numeric_limits<bfloat16>::epsilon)() /
                                   bfloat16(2.0f) +
                               bfloat16(1.0f)));
  ...
  // NaNs and infinities.
  VERIFY(!(numext::isinf)(
      static_cast<float>(bfloat16(3.38e38f)))); // Largest finite number.
...
void test_numtraits() {
  ...
  VERIFY_IS_EQUAL((std::numeric_limits<bfloat16>::denorm_min)() / bfloat16(2),
                  bfloat16(0.f));
}
...
void test_arithmetic() {
  ...
  VERIFY_IS_APPROX(static_cast<float>(bfloat16(0.33333f) + bfloat16(0.66667f)),
                   1.0f);
  VERIFY_IS_EQUAL(static_cast<float>(bfloat16(2.0f) * bfloat16(-5.5f)), -11.0f);
  VERIFY_IS_APPROX(static_cast<float>(bfloat16(1.0f) / bfloat16(3.0f)),
                   0.3339f);
...
void test_basic_functions() {
  ...
  VERIFY_IS_APPROX(
      static_cast<float>(numext::pow(bfloat16(0.0f), bfloat16(1.0f))), 0.0f);
  VERIFY_IS_APPROX(static_cast<float>(pow(bfloat16(0.0f), bfloat16(1.0f))),
                   0.0f);
  VERIFY_IS_APPROX(
      static_cast<float>(numext::pow(bfloat16(2.0f), bfloat16(2.0f))), 4.0f);
  VERIFY_IS_APPROX(static_cast<float>(pow(bfloat16(2.0f), bfloat16(2.0f))),
                   4.0f);

  VERIFY_IS_EQUAL(static_cast<float>(numext::exp(bfloat16(0.0f))), 1.0f);
  VERIFY_IS_EQUAL(static_cast<float>(exp(bfloat16(0.0f))), 1.0f);
  VERIFY_IS_APPROX(static_cast<float>(numext::exp(bfloat16(EIGEN_PI))),
                   20.f + static_cast<float>(EIGEN_PI));
  VERIFY_IS_APPROX(static_cast<float>(exp(bfloat16(EIGEN_PI))),
                   20.f + static_cast<float>(EIGEN_PI));
  ...
  VERIFY_IS_APPROX(static_cast<float>(numext::log1p(bfloat16(10.0f))),
                   2.390625f);
...
void test_trigonometric_functions() {
  ...
  // VERIFY_IS_APPROX(numext::cos(bfloat16(EIGEN_PI/2)),
  // bfloat16(cosf(EIGEN_PI/2)));
  // VERIFY_IS_APPROX(numext::cos(bfloat16(3*EIGEN_PI/2)),
  // bfloat16(cosf(3*EIGEN_PI/2)));
  ...
  // VERIFY_IS_APPROX(numext::sin(bfloat16(EIGEN_PI)),
  // bfloat16(sinf(EIGEN_PI)));
  VERIFY_IS_APPROX(numext::sin(bfloat16(EIGEN_PI / 2)),
                   bfloat16(sinf(EIGEN_PI / 2)));
  VERIFY_IS_APPROX(numext::sin(bfloat16(3 * EIGEN_PI / 2)),
                   bfloat16(sinf(3 * EIGEN_PI / 2)));
  ...
  // VERIFY_IS_APPROX(numext::tan(bfloat16(EIGEN_PI)),
  // bfloat16(tanf(EIGEN_PI)));
  // VERIFY_IS_APPROX(numext::tan(bfloat16(EIGEN_PI/2)),
  // bfloat16(tanf(EIGEN_PI/2)));
  // VERIFY_IS_APPROX(numext::tan(bfloat16(3*EIGEN_PI/2)),
  // bfloat16(tanf(3*EIGEN_PI/2)));
...
void test_product() {
  ...
  VERIFY_IS_APPROX(Ch.noalias() += Ah * Bh,
                   (Cf.noalias() += Af * Bf).cast<bfloat16>());
}
