...
template <typename Scalar> struct check_ostream_impl {
  static void run() {
...
template <> struct check_ostream_impl<bool> {
  static void run() {
...
template <typename Scalar> struct check_ostream_impl<std::complex<Scalar>> {
  static void run() {
...
template <typename Scalar> static void check_ostream() {
