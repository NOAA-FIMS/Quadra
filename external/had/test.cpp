...
#define NearEqualAssert(a, b) assert(std::fabs((a) - (b)) < 1e-8)
...
void TestDivision() {
  ...
  NearEqualAssert(dydx1x1, (Real(2.0) * x0.val * x0.val) /
                               (x1.val * x1.val * x1.val * x2.val));
  NearEqualAssert(dydx1x2,
                  x0.val * x0.val / (x1.val * x1.val * x2.val * x2.val));
  NearEqualAssert(dydx2x2, (Real(2.0) * x0.val * x0.val) /
                               (x1.val * x2.val * x2.val * x2.val));
}
...
void TestSqrt() {
  ...
  NearEqualAssert(dydx2,
                  Real(1.0) / (Real(2.0) * sqrt(x0.val * x1.val + x2.val)));

  NearEqualAssert(dydx0x0, -(x1.val * x1.val) /
                               (Real(4.0) * pow(x0.val * x1.val + x2.val,
                                                Real(3.0 / 2.0))));
  NearEqualAssert(dydx0x1, (x0.val * x1.val + Real(2.0) * x2.val) /
                               (Real(4.0) * pow(x0.val * x1.val + x2.val,
                                                Real(3.0 / 2.0))));
  NearEqualAssert(
      dydx0x2,
      -(x1.val) / (Real(4.0) * pow(x0.val * x1.val + x2.val, Real(3.0 / 2.0))));
  NearEqualAssert(dydx1x1, -(x0.val * x0.val) /
                               (Real(4.0) * pow(x0.val * x1.val + x2.val,
                                                Real(3.0 / 2.0))));
  NearEqualAssert(
      dydx1x2,
      -(x0.val) / (Real(4.0) * pow(x0.val * x1.val + x2.val, Real(3.0 / 2.0))));
  NearEqualAssert(dydx2x2,
                  -Real(1.0) / (Real(4.0) * pow(x0.val * x1.val + x2.val,
                                                Real(3.0 / 2.0))));
}
...
void TestExp() {
  ...
  NearEqualAssert(dydx0x0, Real(2.0) *
                               (Real(2.0) * x0.val * x0.val + Real(1.0)) *
                               exp(x0.val * x0.val + x1.val));
...
void TestLog() {
  ...
  NearEqualAssert(
      dydx0x0, -Real(2.0) * (x0.val * x0.val - x1.val) /
                   ((x0.val * x0.val + x1.val) * (x0.val * x0.val + x1.val)));
  NearEqualAssert(
      dydx0x1, -Real(2.0) * x0.val /
                   ((x0.val * x0.val + x1.val) * (x0.val * x0.val + x1.val)));
  NearEqualAssert(dydx1x1, -Real(1.0) / ((x0.val * x0.val + x1.val) *
                                         (x0.val * x0.val + x1.val)));
}
...
void TestTan() {
  ...
  NearEqualAssert(dydx0x0, Real(2.0) * tan(x0.val) * tan(x1.val) /
                               (cos(x0.val) * cos(x0.val)));
  NearEqualAssert(dydx0x1, Real(1.0) / (cos(x0.val) * cos(x0.val) *
                                        cos(x1.val) * cos(x1.val)));
  NearEqualAssert(dydx1x1, Real(2.0) * tan(x0.val) * tan(x1.val) /
                               (cos(x1.val) * cos(x1.val)));
}
...
void TestASin() {
  ...
  NearEqualAssert(dydx0x0,
                  x0.val * asin(x1.val) /
                      pow(Real(1.0) - x0.val * x0.val, Real(3.0) / Real(2.0)));
  NearEqualAssert(dydx0x1, Real(1.0) / (sqrt(Real(1.0) - x0.val * x0.val) *
                                        sqrt(Real(1.0) - x1.val * x1.val)));
  NearEqualAssert(dydx1x1,
                  x1.val * asin(x0.val) /
                      pow(Real(1.0) - x1.val * x1.val, Real(3.0) / Real(2.0)));
}
