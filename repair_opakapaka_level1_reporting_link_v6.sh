...
echo "== Repair Opakapaka Level-1 reporting inspector linker =="

cat > inspect_opakapaka_level1_reporting_v6.sh <<'SH'
#!/usr/bin/env bash
set -euo pipefail
...
chmod +x inspect_opakapaka_level1_reporting_v6.sh
