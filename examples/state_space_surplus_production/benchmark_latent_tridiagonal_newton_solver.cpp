...
int main(int argc, char** argv) {
  ...
  std::cout << std::setw(8) << "n"
            ...
            << std::setw(14) << "newton_ms"
            << std::setw(14) << "speedup"
            << std::setw(12) << "newton_it"
  ...
  for (const int n : lengths) {
    ...
    for (int r = 0; r < reps; ++r) {
      ...
      last_newton = eval_with_xhat_direct_runtime(
          data, par, newton_last.xhat, runtime);
    }
    ...
    std::cout << std::setw(8) << n
              << std::setw(14) << last_newton.objective
              << std::setw(14) << lbfgs_ms
              << std::setw(14) << newton_ms
              << std::setw(14) << speedup
              << std::setw(12) << newton_last.iterations
              << std::setw(14) << last_newton.grad_norm
              << std::setw(16) << objective_diff
              << "\n";
  }
