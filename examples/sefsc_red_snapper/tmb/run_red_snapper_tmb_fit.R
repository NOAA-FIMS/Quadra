...
data_candidates <- c(
  "examples/sefsc_red_snapper/data/red_snapper_synthetic_observations.csv",
  "examples/sefsc_red_snapper/data/synthetic_red_snapper_observations.csv",
  "examples/sefsc_red_snapper/data/red_snapper_observations.csv"
)
...
cpp <- "examples/sefsc_red_snapper/tmb/red_snapper_tmb.cpp"
TMB::compile(cpp)
...
summary_path <- "examples/sefsc_red_snapper/outputs/tmb_fit_summary.csv"
out <- data.frame(
...
rec_path <- "examples/sefsc_red_snapper/outputs/tmb_recruitment_deviations.csv"
