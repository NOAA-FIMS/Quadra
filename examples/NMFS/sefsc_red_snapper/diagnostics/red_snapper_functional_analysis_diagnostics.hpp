...
inline std::size_t red_snapper_max_fixed_gradient_index(
...
Eigen::MatrixXd red_snapper_fd_huu(
    Objective &objective,
    ...
    double rel_step = 1.0e-4)
{
  ...
  Eigen::MatrixXd H =
      Eigen::MatrixXd::Zero(static_cast<Eigen::Index>(n_random),
