...
#include "../reference_points/red_snapper_reference_points.hpp"
...
struct RedSnapperReportPaths {
  ...
  std::string residual_diagnostics = "examples/NMFS/sefsc_red_snapper/outputs/"
  ...
  std::string objective_components = "examples/NMFS/sefsc_red_snapper/outputs/"
