...
struct BigeyeReportPaths {
  std::string summary = "examples/NMFS/pifsc_bigeye_tuna/level0_single_region/"
                        "outputs/bigeye_fit_summary.csv";
  std::string trajectory =
      "examples/NMFS/pifsc_bigeye_tuna/level0_single_region/outputs/"
      "bigeye_fitted_trajectory.csv";
  std::string residual_diagnostics =
      "examples/NMFS/pifsc_bigeye_tuna/level0_single_region/outputs/"
      "bigeye_residual_diagnostics.csv";
  std::string selectivity =
      "examples/NMFS/pifsc_bigeye_tuna/level0_single_region/outputs/"
      "bigeye_selectivity_at_age.csv";
  std::string recruitment_deviations =
      "examples/NMFS/pifsc_bigeye_tuna/level0_single_region/outputs/"
      "bigeye_recruitment_deviations.csv";
