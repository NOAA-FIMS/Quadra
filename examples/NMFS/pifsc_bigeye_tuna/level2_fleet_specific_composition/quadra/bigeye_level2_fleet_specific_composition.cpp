...
int main() {
  const std::string input_path =
      "examples/NMFS/pifsc_bigeye_tuna/level2_fleet_specific_composition/data/"
      "synthetic_bigeye_level2_fleet_specific_composition_observations.csv";
  ...
  pifsc_bigeye_tuna::write_bigeye_functional_analysis_report(
      "examples/NMFS/pifsc_bigeye_tuna/level2_fleet_specific_composition/"
      "outputs/"
      "bigeye_level2_functional_analysis_report.txt",
      "examples/NMFS/pifsc_bigeye_tuna/level2_fleet_specific_composition/"
      "outputs/"
      "bigeye_level2_functional_analysis_report.csv",
      objective, params, fit);
  pifsc_bigeye_tuna::write_bigeye_fixed_effect_geometry_report(
      "examples/NMFS/pifsc_bigeye_tuna/level2_fleet_specific_composition/"
      "outputs/"
      "bigeye_level2_fixed_effect_geometry_report.txt",
      "examples/NMFS/pifsc_bigeye_tuna/level2_fleet_specific_composition/"
      "outputs/"
      "bigeye_level2_fixed_effect_geometry_report.csv",
      objective, params, fit, opts);
  std::cout << "PIFSC bigeye-tuna-style Level 2 fleet-specific-composition "
  ...
  std::cout << "wrote:      "
            << "examples/NMFS/pifsc_bigeye_tuna/"
               "level2_fleet_specific_composition/outputs/"
               "bigeye_level2_functional_analysis_report.txt\n";
