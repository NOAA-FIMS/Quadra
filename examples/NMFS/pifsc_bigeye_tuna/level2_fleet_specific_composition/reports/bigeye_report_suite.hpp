...
struct BigeyeReportPaths {
  std::string summary =
      "examples/NMFS/pifsc_bigeye_tuna/level2_fleet_specific_composition/outputs/bigeye_level2_fit_summary.csv";
  std::string trajectory =
      "examples/NMFS/pifsc_bigeye_tuna/level2_fleet_specific_composition/outputs/bigeye_level2_fitted_trajectory.csv";
  std::string residual_diagnostics = "examples/NMFS/pifsc_bigeye_tuna/level2_fleet_specific_composition/outputs/"
                                     "bigeye_level2_residual_diagnostics.csv";
  std::string selectivity =
      "examples/NMFS/pifsc_bigeye_tuna/level2_fleet_specific_composition/outputs/bigeye_level2_selectivity_at_age.csv";
  std::string recruitment_deviations =
      "examples/NMFS/pifsc_bigeye_tuna/level2_fleet_specific_composition/outputs/bigeye_level2_recruitment_deviations.csv";
  std::string objective_components = "examples/NMFS/pifsc_bigeye_tuna/level2_fleet_specific_composition/outputs/"
                                     "bigeye_level2_objective_components.csv";
  std::string laplace_structure_text =
      "examples/NMFS/pifsc_bigeye_tuna/level2_fleet_specific_composition/outputs/"
      "bigeye_level2_laplace_structure_report.txt";
  std::string laplace_structure_csv =
      "examples/NMFS/pifsc_bigeye_tuna/level2_fleet_specific_composition/outputs/"
      "bigeye_level2_laplace_structure_report.csv";
  std::string reference_points =
      "examples/NMFS/pifsc_bigeye_tuna/level2_fleet_specific_composition/outputs/"
      "bigeye_level2_reference_points.csv";
};
