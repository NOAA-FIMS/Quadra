...
struct BigeyeReportPaths {
  std::string summary =
      ...
      "outputs/bigeye_level2_fit_summary.csv";
  std::string trajectory =
      "examples/NMFS/pifsc_bigeye_tuna/level2_fleet_specific_composition/"
      "outputs/bigeye_level2_fitted_trajectory.csv";
  ...
  std::string selectivity =
      "examples/NMFS/pifsc_bigeye_tuna/level2_fleet_specific_composition/"
      "outputs/bigeye_level2_selectivity_at_age.csv";
  std::string recruitment_deviations =
      "examples/NMFS/pifsc_bigeye_tuna/level2_fleet_specific_composition/"
      "outputs/bigeye_level2_recruitment_deviations.csv";
