...
int main() {
  const std::string input_path =
      "examples/NMFS/pifsc_bigeye_tuna/level4_distinct_vulnerable_indices/data/"
      "synthetic_bigeye_level4_distinct_vulnerable_indices_observations.csv";
  ...
  pifsc_bigeye_tuna::write_bigeye_functional_analysis_report(
      "examples/NMFS/pifsc_bigeye_tuna/level4_distinct_vulnerable_indices/"
      "outputs/"
      "bigeye_level4_functional_analysis_report.txt",
      "examples/NMFS/pifsc_bigeye_tuna/level4_distinct_vulnerable_indices/"
      "outputs/"
      "bigeye_level4_functional_analysis_report.csv",
      objective, params, fit);
  pifsc_bigeye_tuna::write_bigeye_fixed_effect_geometry_report(
      "examples/NMFS/pifsc_bigeye_tuna/level4_distinct_vulnerable_indices/"
      "outputs/"
      "bigeye_level4_fixed_effect_geometry_report.txt",
      "examples/NMFS/pifsc_bigeye_tuna/level4_distinct_vulnerable_indices/"
      "outputs/"
      "bigeye_level4_fixed_effect_geometry_report.csv",
      objective, params, fit, opts);
  pifsc_bigeye_tuna::write_bigeye_fixed_effect_wiggle_diagnostics(
      "examples/NMFS/pifsc_bigeye_tuna/level4_distinct_vulnerable_indices/"
      "outputs/"
      "bigeye_level4_fixed_effect_wiggle_diagnostics.txt",
      "examples/NMFS/pifsc_bigeye_tuna/level4_distinct_vulnerable_indices/"
      "outputs/"
      "bigeye_level4_fixed_effect_wiggle_diagnostics.csv",
      objective, params, fit, opts);
  std::cout << "PIFSC bigeye-tuna-style Level 4 distinct-vulnerable-indices "
               "Quadra Laplace recruitment-deviation fit\n";
  ...
  std::cout << "wrote:      "
            << "examples/NMFS/pifsc_bigeye_tuna/"
               "level4_distinct_vulnerable_indices/outputs/"
               "bigeye_level4_functional_analysis_report.txt\n";
