...
struct BigeyeReportPaths {
  std::string summary =
      ...
      "outputs/bigeye_level4_fit_summary.csv";
  std::string trajectory =
      "examples/NMFS/pifsc_bigeye_tuna/level4_distinct_vulnerable_indices/"
      "outputs/bigeye_level4_fitted_trajectory.csv";
  ...
  std::string selectivity =
      "examples/NMFS/pifsc_bigeye_tuna/level4_distinct_vulnerable_indices/"
      "outputs/bigeye_level4_selectivity_at_age.csv";
  std::string recruitment_deviations =
      "examples/NMFS/pifsc_bigeye_tuna/level4_distinct_vulnerable_indices/"
      "outputs/bigeye_level4_recruitment_deviations.csv";
