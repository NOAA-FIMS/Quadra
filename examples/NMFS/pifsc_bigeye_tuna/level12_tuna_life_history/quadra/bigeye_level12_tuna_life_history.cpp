...
int main()
{
  ...
  std::cout << "wrote:      "
    ...
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level12_tuna_life_history/outputs/bigeye_level12_objective_consistency_check.txt\n";
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level12_tuna_life_history/outputs/bigeye_level12_objective_consistency_check.csv\n";
