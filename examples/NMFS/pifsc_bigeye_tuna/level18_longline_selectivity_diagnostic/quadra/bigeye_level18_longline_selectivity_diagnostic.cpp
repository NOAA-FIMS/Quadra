...
int main() {
  const std::string input_path = "examples/NMFS/pifsc_bigeye_tuna/"
                                 "level18_longline_selectivity_diagnostic/data/"
                                 "synthetic_bigeye_level18_longline_"
                                 "selectivity_diagnostic_observations.csv";
...

  {
    ...
    std::ofstream out("examples/NMFS/pifsc_bigeye_tuna/"
                      "level18_longline_selectivity_diagnostic/outputs/"
