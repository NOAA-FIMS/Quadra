...
int main() {
  const std::string input_path = "examples/NMFS/pifsc_bigeye_tuna/"
                                 "level3_fleet_specific_selectivity_index/data/"
                                 "synthetic_bigeye_level3_fleet_specific_"
                                 "selectivity_index_observations.csv";
  ...
  pifsc_bigeye_tuna::write_bigeye_functional_analysis_report(
      "examples/NMFS/pifsc_bigeye_tuna/level3_fleet_specific_selectivity_index/"
      "outputs/"
      "bigeye_level3_functional_analysis_report.txt",
      "examples/NMFS/pifsc_bigeye_tuna/level3_fleet_specific_selectivity_index/"
      "outputs/"
      "bigeye_level3_functional_analysis_report.csv",
      objective, params, fit);
  pifsc_bigeye_tuna::write_bigeye_fixed_effect_geometry_report(
      "examples/NMFS/pifsc_bigeye_tuna/level3_fleet_specific_selectivity_index/"
      "outputs/"
      "bigeye_level3_fixed_effect_geometry_report.txt",
      "examples/NMFS/pifsc_bigeye_tuna/level3_fleet_specific_selectivity_index/"
      "outputs/"
      "bigeye_level3_fixed_effect_geometry_report.csv",
      objective, params, fit, opts);
  std::cout
      << "PIFSC bigeye-tuna-style Level 3 fleet-specific-selectivity-index "
  ...
  std::cout << "wrote:      "
            << "examples/NMFS/pifsc_bigeye_tuna/"
               "level3_fleet_specific_selectivity_index/outputs/"
               "bigeye_level3_functional_analysis_report.txt\n";
