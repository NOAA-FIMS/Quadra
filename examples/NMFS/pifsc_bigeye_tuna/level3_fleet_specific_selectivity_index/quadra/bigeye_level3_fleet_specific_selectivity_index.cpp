...
int main()
{
    const std::string input_path =
        "examples/NMFS/pifsc_bigeye_tuna/level3_fleet_specific_selectivity_index/data/"
        "synthetic_bigeye_level3_fleet_specific_selectivity_index_observations.csv";
    ...
    std::cout
        << "PIFSC bigeye-tuna-style Level 3 fleet-specific-selectivity-index Quadra Laplace recruitment-deviation fit\n";
