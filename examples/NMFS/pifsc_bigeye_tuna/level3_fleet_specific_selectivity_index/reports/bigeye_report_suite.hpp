...
struct BigeyeReportPaths {
  std::string summary =
      ...
      "outputs/bigeye_level3_fit_summary.csv";
  std::string trajectory =
      "examples/NMFS/pifsc_bigeye_tuna/level3_fleet_specific_selectivity_index/"
      "outputs/bigeye_level3_fitted_trajectory.csv";
  ...
  std::string selectivity =
      "examples/NMFS/pifsc_bigeye_tuna/level3_fleet_specific_selectivity_index/"
      "outputs/bigeye_level3_selectivity_at_age.csv";
  std::string recruitment_deviations =
      "examples/NMFS/pifsc_bigeye_tuna/level3_fleet_specific_selectivity_index/"
      "outputs/bigeye_level3_recruitment_deviations.csv";
