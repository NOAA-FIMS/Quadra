...
int main()
{
    const std::string input_path =
        "examples/NMFS/pifsc_bigeye_tuna/level7_dual_age_selectivity/data/"
        "synthetic_bigeye_level7_dual_age_selectivity_observations.csv";
    ...
    std::filesystem::create_directories("examples/NMFS/pifsc_bigeye_tuna/level7_dual_age_selectivity/outputs");
    ...
    pifsc_bigeye_tuna::write_recruitment_diagnostics(
        ...
        "bigeye_level7_recruitment_diagnostics.txt",
        "examples/NMFS/pifsc_bigeye_tuna/level7_dual_age_selectivity/outputs/"
        "bigeye_level7_recruitment_diagnostics.csv",
        objective, fit);

    pifsc_bigeye_tuna::write_safe_fixed_effect_wiggle_diagnostics(
        "examples/NMFS/pifsc_bigeye_tuna/level7_dual_age_selectivity/outputs/"
        "bigeye_level7_safe_fixed_effect_wiggle_diagnostics.txt",
        "examples/NMFS/pifsc_bigeye_tuna/level7_dual_age_selectivity/outputs/"
        "bigeye_level7_safe_fixed_effect_wiggle_diagnostics.csv",
