...
int main()
{
    ...
    pifsc_bigeye_tuna::write_level13_initial_numbers_diagnostics(
        ...
        fit);
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level14_m_sensitivity/outputs/bigeye_level14_initial_numbers_diagnostics.txt\n";
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level14_m_sensitivity/outputs/bigeye_level14_initial_numbers_diagnostics.csv\n";
  ...
  std::cout << "wrote:      "
    ...
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level14_m_sensitivity/outputs/bigeye_level14_objective_consistency_check.txt\n";
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level14_m_sensitivity/outputs/bigeye_level14_objective_consistency_check.csv\n";
