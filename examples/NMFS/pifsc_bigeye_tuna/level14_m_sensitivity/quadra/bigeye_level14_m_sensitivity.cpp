...
int main() {
  const std::string input_path =
      "examples/NMFS/pifsc_bigeye_tuna/level14_m_sensitivity/data/"
      "synthetic_bigeye_level14_m_sensitivity_observations.csv";
  ...
  double fixed_m = 0.18;
  if (const char *env_m = std::getenv("BIGEYE_FIXED_M")) {
    fixed_m = std::stod(env_m);
  }

  pifsc_bigeye_tuna::BigeyeQuadraObjective objective(fleet_observations,
                                                     fixed_m);
  std::cout << "fixed_m:   " << fixed_m << "\n";
...

  {
    ...
    std::ofstream out(
        "examples/NMFS/pifsc_bigeye_tuna/level14_m_sensitivity/outputs/"
        "bigeye_level14_objective_consistency_check.csv");
    if (!out) {
    ...
    std::ofstream txt(
        "examples/NMFS/pifsc_bigeye_tuna/level14_m_sensitivity/outputs/"
        "bigeye_level14_objective_consistency_check.txt");
    if (!txt) {
      throw std::runtime_error(
  ...
  pifsc_bigeye_tuna::write_level13_initial_numbers_diagnostics(
      "examples/NMFS/pifsc_bigeye_tuna/level14_m_sensitivity/outputs/"
      "bigeye_level14_initial_numbers_diagnostics.txt",
      "examples/NMFS/pifsc_bigeye_tuna/level14_m_sensitivity/outputs/"
      "bigeye_level14_initial_numbers_diagnostics.csv",
      fit);
  std::cout << "wrote:      "
               "examples/NMFS/pifsc_bigeye_tuna/level14_m_sensitivity/outputs/"
               "bigeye_level14_initial_numbers_diagnostics.txt\n";
  ...
  pifsc_bigeye_tuna::write_recruitment_diagnostics(
      "examples/NMFS/pifsc_bigeye_tuna/level14_m_sensitivity/outputs/"
      "bigeye_level14_recruitment_diagnostics.txt",
      "examples/NMFS/pifsc_bigeye_tuna/level14_m_sensitivity/outputs/"
      "bigeye_level14_recruitment_diagnostics.csv",
      objective, fit);

  pifsc_bigeye_tuna::write_longline_slope_geometry_scan(
      "examples/NMFS/pifsc_bigeye_tuna/level14_m_sensitivity/outputs/"
      "bigeye_level14_longline_slope_geometry_scan.txt",
      "examples/NMFS/pifsc_bigeye_tuna/level14_m_sensitivity/outputs/"
      "bigeye_level14_longline_slope_geometry_scan.csv",
      objective, params, fit, opts);

  pifsc_bigeye_tuna::write_safe_fixed_effect_wiggle_diagnostics(
      "examples/NMFS/pifsc_bigeye_tuna/level14_m_sensitivity/outputs/"
      "bigeye_level14_safe_fixed_effect_wiggle_diagnostics.txt",
      "examples/NMFS/pifsc_bigeye_tuna/level14_m_sensitivity/outputs/"
      "bigeye_level14_safe_fixed_effect_wiggle_diagnostics.csv",
      objective, params, fit, opts);
