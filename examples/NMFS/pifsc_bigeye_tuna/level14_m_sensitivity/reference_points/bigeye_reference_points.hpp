...
inline AgeStructuredParams bigeye_params_from_fit(
...
inline double bigeye_spr_proxy(double fbar, double sel_a50,
                                    double sel_slope)
{
  const double m = 0.18;
...
inline double bigeye_find_f_for_spr_ratio(double target_ratio,
                                               double sel_a50,
                                               double sel_slope)
{
...
inline BigeyeReferencePoints compute_bigeye_reference_points(
...
inline void write_bigeye_reference_points_csv(
