...
struct BigeyeReportPaths {
  std::string summary =
      "examples/NMFS/pifsc_bigeye_tuna/level5_selectivity_contrast/outputs/bigeye_level5_fit_summary.csv";
  std::string trajectory =
      "examples/NMFS/pifsc_bigeye_tuna/level5_selectivity_contrast/outputs/bigeye_level5_fitted_trajectory.csv";
  std::string residual_diagnostics = "examples/NMFS/pifsc_bigeye_tuna/level5_selectivity_contrast/outputs/"
                                     "bigeye_level5_residual_diagnostics.csv";
  std::string selectivity =
      "examples/NMFS/pifsc_bigeye_tuna/level5_selectivity_contrast/outputs/bigeye_level5_selectivity_at_age.csv";
  std::string recruitment_deviations =
      "examples/NMFS/pifsc_bigeye_tuna/level5_selectivity_contrast/outputs/bigeye_level5_recruitment_deviations.csv";
  std::string objective_components = "examples/NMFS/pifsc_bigeye_tuna/level5_selectivity_contrast/outputs/"
