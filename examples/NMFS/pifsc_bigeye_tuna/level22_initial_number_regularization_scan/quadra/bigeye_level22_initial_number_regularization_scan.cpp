...
int main() {
  ...
  const std::string input_path =
      ...
      "level22_initial_number_regularization_scan/data/"
      "synthetic_bigeye_level22_initial_number_regularization_scan_"
      "observations.csv";
...

  {
    ...
    std::ofstream out("examples/NMFS/pifsc_bigeye_tuna/"
                      "level22_initial_number_regularization_scan/outputs/"
