...
#include "../diagnostics/bigeye_level19_parameter_sanity_diagnostics.hpp"
...
int main()
{
    const std::string input_path =
        "examples/NMFS/pifsc_bigeye_tuna/level19_flexible_longline_selectivity/data/"
        "synthetic_bigeye_level19_flexible_longline_selectivity_observations.csv";
...

    {
      ...
      std::ofstream out(
          "examples/NMFS/pifsc_bigeye_tuna/level19_flexible_longline_selectivity/outputs/"
          "bigeye_level19_objective_consistency_check.csv");
      if (!out) {
      ...
      std::ofstream txt(
          "examples/NMFS/pifsc_bigeye_tuna/level19_flexible_longline_selectivity/outputs/"
          "bigeye_level19_objective_consistency_check.txt");
      if (!txt) {
    ...
    pifsc_bigeye_tuna::write_level13_initial_numbers_diagnostics(
        "examples/NMFS/pifsc_bigeye_tuna/level19_flexible_longline_selectivity/outputs/"
        "bigeye_level19_initial_numbers_diagnostics.txt",
        "examples/NMFS/pifsc_bigeye_tuna/level19_flexible_longline_selectivity/outputs/"
        "bigeye_level19_initial_numbers_diagnostics.csv",
        fit);
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level19_flexible_longline_selectivity/outputs/bigeye_level19_initial_numbers_diagnostics.txt\n";
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level19_flexible_longline_selectivity/outputs/bigeye_level19_initial_numbers_diagnostics.csv\n";

    pifsc_bigeye_tuna::write_recruitment_diagnostics(
        "examples/NMFS/pifsc_bigeye_tuna/level19_flexible_longline_selectivity/outputs/"
        "bigeye_level19_recruitment_diagnostics.txt",
        "examples/NMFS/pifsc_bigeye_tuna/level19_flexible_longline_selectivity/outputs/"
        "bigeye_level19_recruitment_diagnostics.csv",
        objective, fit);

    pifsc_bigeye_tuna::write_longline_slope_geometry_scan(
        "examples/NMFS/pifsc_bigeye_tuna/level19_flexible_longline_selectivity/outputs/"
        "bigeye_level19_longline_slope_geometry_scan.txt",
        "examples/NMFS/pifsc_bigeye_tuna/level19_flexible_longline_selectivity/outputs/"
        "bigeye_level19_longline_slope_geometry_scan.csv",
        objective, params, fit, opts);

    pifsc_bigeye_tuna::write_safe_fixed_effect_wiggle_diagnostics(
        "examples/NMFS/pifsc_bigeye_tuna/level19_flexible_longline_selectivity/outputs/"
        "bigeye_level19_safe_fixed_effect_wiggle_diagnostics.txt",
        "examples/NMFS/pifsc_bigeye_tuna/level19_flexible_longline_selectivity/outputs/"
        "bigeye_level19_safe_fixed_effect_wiggle_diagnostics.csv",
        objective, params, fit, opts);
  ...
  std::cout << "wrote:      "
    ...
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level19_flexible_longline_selectivity/outputs/bigeye_level19_objective_consistency_check.txt\n";
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level19_flexible_longline_selectivity/outputs/bigeye_level19_objective_consistency_check.csv\n";


    pifsc_bigeye_tuna::write_level15_age_comp_residual_diagnostics(
        "examples/NMFS/pifsc_bigeye_tuna/level19_flexible_longline_selectivity/outputs/"
        "bigeye_level19_age_comp_residual_diagnostics.txt",
        "examples/NMFS/pifsc_bigeye_tuna/level19_flexible_longline_selectivity/outputs/"
        "bigeye_level19_age_comp_residual_diagnostics.csv",
        objective,
        fit);
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level19_flexible_longline_selectivity/outputs/bigeye_level19_age_comp_residual_diagnostics.txt\n";
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level19_flexible_longline_selectivity/outputs/bigeye_level19_age_comp_residual_diagnostics.csv\n";

    pifsc_bigeye_tuna::write_level16_purse_seine_prediction_decomposition(
        "examples/NMFS/pifsc_bigeye_tuna/level19_flexible_longline_selectivity/outputs/"
        "bigeye_level19_purse_seine_prediction_decomposition.txt",
        "examples/NMFS/pifsc_bigeye_tuna/level19_flexible_longline_selectivity/outputs/"
        "bigeye_level19_purse_seine_prediction_decomposition.csv",
        objective, fit);
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level19_flexible_longline_selectivity/outputs/bigeye_level19_purse_seine_prediction_decomposition.txt\n";
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level19_flexible_longline_selectivity/outputs/bigeye_level19_purse_seine_prediction_decomposition.csv\n";

    pifsc_bigeye_tuna::write_level18_longline_prediction_decomposition(
        "examples/NMFS/pifsc_bigeye_tuna/level19_flexible_longline_selectivity/outputs/"
        "bigeye_level19_longline_prediction_decomposition.txt",
        "examples/NMFS/pifsc_bigeye_tuna/level19_flexible_longline_selectivity/outputs/"
        "bigeye_level19_longline_prediction_decomposition.csv",
        objective, fit);
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level19_flexible_longline_selectivity/outputs/bigeye_level19_longline_prediction_decomposition.txt\n";
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level19_flexible_longline_selectivity/outputs/bigeye_level19_longline_prediction_decomposition.csv\n";


    pifsc_bigeye_tuna::write_level19_parameter_sanity_diagnostics(
        "examples/NMFS/pifsc_bigeye_tuna/level19_flexible_longline_selectivity/outputs/"
        "bigeye_level19_parameter_sanity_diagnostics.txt",
        "examples/NMFS/pifsc_bigeye_tuna/level19_flexible_longline_selectivity/outputs/"
        "bigeye_level19_parameter_sanity_diagnostics.csv",
        fit);
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level19_flexible_longline_selectivity/outputs/bigeye_level19_parameter_sanity_diagnostics.txt\n";
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level19_flexible_longline_selectivity/outputs/bigeye_level19_parameter_sanity_diagnostics.csv\n";
