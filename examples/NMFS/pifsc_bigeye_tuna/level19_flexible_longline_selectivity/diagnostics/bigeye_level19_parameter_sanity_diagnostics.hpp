...
inline void write_level19_parameter_sanity_diagnostics(
    ...
    const quadra::OptResult &fit)
{
  ...
  if (!txt || !csv) {
    throw std::runtime_error("Cannot write Level 19 parameter sanity diagnostics");
  }
  ...
  txt << "Level 19 Parameter Sanity Diagnostics\n";
  txt << "=====================================\n\n";
  txt << "Purpose\n";
  txt << "-------\n";
  txt << "Check whether Level 19 improved the age-composition fit by creating\n";
  ...
  txt << "departures, indicate that Level 19 may be fitting composition data by\n";
...
using pifsc_bigeye_tuna::write_level19_parameter_sanity_diagnostics;
