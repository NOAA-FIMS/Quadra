...
struct BigeyeReportPaths {
  std::string summary =
      "examples/NMFS/pifsc_bigeye_tuna/level6_purse_seine_age_selectivity/"
      "outputs/bigeye_level6_fit_summary.csv";
  std::string trajectory =
      "examples/NMFS/pifsc_bigeye_tuna/level6_purse_seine_age_selectivity/"
      "outputs/bigeye_level6_fitted_trajectory.csv";
  ...
  std::string selectivity =
      "examples/NMFS/pifsc_bigeye_tuna/level6_purse_seine_age_selectivity/"
      "outputs/bigeye_level6_selectivity_at_age.csv";
  std::string recruitment_deviations =
      "examples/NMFS/pifsc_bigeye_tuna/level6_purse_seine_age_selectivity/"
      "outputs/bigeye_level6_recruitment_deviations.csv";
  ...
  std::string reference_points = "examples/NMFS/pifsc_bigeye_tuna/"
                                 "level6_purse_seine_age_selectivity/outputs/"
