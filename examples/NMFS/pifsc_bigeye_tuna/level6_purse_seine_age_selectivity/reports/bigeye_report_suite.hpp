...
struct BigeyeReportPaths {
  std::string summary =
      "examples/NMFS/pifsc_bigeye_tuna/level6_purse_seine_age_selectivity/outputs/bigeye_level6_fit_summary.csv";
  std::string trajectory =
      "examples/NMFS/pifsc_bigeye_tuna/level6_purse_seine_age_selectivity/outputs/bigeye_level6_fitted_trajectory.csv";
  std::string residual_diagnostics = "examples/NMFS/pifsc_bigeye_tuna/level6_purse_seine_age_selectivity/outputs/"
                                     "bigeye_level6_residual_diagnostics.csv";
  std::string selectivity =
      "examples/NMFS/pifsc_bigeye_tuna/level6_purse_seine_age_selectivity/outputs/bigeye_level6_selectivity_at_age.csv";
  std::string recruitment_deviations =
      "examples/NMFS/pifsc_bigeye_tuna/level6_purse_seine_age_selectivity/outputs/bigeye_level6_recruitment_deviations.csv";
  std::string objective_components = "examples/NMFS/pifsc_bigeye_tuna/level6_purse_seine_age_selectivity/outputs/"
                                     "bigeye_level6_objective_components.csv";
  std::string laplace_structure_text =
      "examples/NMFS/pifsc_bigeye_tuna/level6_purse_seine_age_selectivity/outputs/"
      "bigeye_level6_laplace_structure_report.txt";
  std::string laplace_structure_csv =
      "examples/NMFS/pifsc_bigeye_tuna/level6_purse_seine_age_selectivity/outputs/"
      "bigeye_level6_laplace_structure_report.csv";
  std::string reference_points =
      "examples/NMFS/pifsc_bigeye_tuna/level6_purse_seine_age_selectivity/outputs/"
      "bigeye_level6_reference_points.csv";
};
