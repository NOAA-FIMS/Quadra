...
int main() {
  const std::string input_path =
      "examples/NMFS/pifsc_bigeye_tuna/level6_purse_seine_age_selectivity/data/"
      "synthetic_bigeye_level6_purse_seine_age_selectivity_observations.csv";
  ...
  pifsc_bigeye_tuna::write_safe_fixed_effect_wiggle_diagnostics(
      "examples/NMFS/pifsc_bigeye_tuna/level6_purse_seine_age_selectivity/"
      "outputs/"
      "bigeye_level6_safe_fixed_effect_wiggle_diagnostics.txt",
      "examples/NMFS/pifsc_bigeye_tuna/level6_purse_seine_age_selectivity/"
      "outputs/"
      "bigeye_level6_safe_fixed_effect_wiggle_diagnostics.csv",
      objective, params, fit, opts);
