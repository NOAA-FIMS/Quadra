...
int main()
{
  ...
  std::cout << "wrote:      "
    ...
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level10_q_anchor/outputs/bigeye_level10_objective_consistency_check.txt\n";
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level10_q_anchor/outputs/bigeye_level10_objective_consistency_check.csv\n";
