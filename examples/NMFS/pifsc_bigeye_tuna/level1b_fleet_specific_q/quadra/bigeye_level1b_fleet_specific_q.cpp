...
int main() {
  const std::string input_path =
      "examples/NMFS/pifsc_bigeye_tuna/level1b_fleet_specific_q/data/"
      "synthetic_bigeye_level1b_fleet_specific_q_observations.csv";
  ...
  pifsc_bigeye_tuna::write_bigeye_functional_analysis_report(
      ...
      "bigeye_level1b_functional_analysis_report.txt",
      "examples/NMFS/pifsc_bigeye_tuna/level1b_fleet_specific_q/outputs/"
      "bigeye_level1b_functional_analysis_report.csv",
      objective, params, fit);
  pifsc_bigeye_tuna::write_bigeye_fixed_effect_geometry_report(
      "examples/NMFS/pifsc_bigeye_tuna/level1b_fleet_specific_q/outputs/"
      "bigeye_level1b_fixed_effect_geometry_report.txt",
      "examples/NMFS/pifsc_bigeye_tuna/level1b_fleet_specific_q/outputs/"
      "bigeye_level1b_fixed_effect_geometry_report.csv",
      objective, params, fit, opts);
  std::cout << "PIFSC bigeye-tuna-style Level 1B fleet-specific-q Quadra "
               "Laplace recruitment-deviation fit\n";
