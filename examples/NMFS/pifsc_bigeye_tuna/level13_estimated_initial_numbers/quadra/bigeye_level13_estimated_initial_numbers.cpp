...
int main() {
...

  {
    ...
    std::ofstream out("examples/NMFS/pifsc_bigeye_tuna/"
                      "level13_estimated_initial_numbers/outputs/"
  ...
  pifsc_bigeye_tuna::write_level13_initial_numbers_diagnostics(
      "examples/NMFS/pifsc_bigeye_tuna/level13_estimated_initial_numbers/"
      "outputs/"
  ...
  std::cout
      << "wrote:      "
         "examples/NMFS/pifsc_bigeye_tuna/level13_estimated_initial_numbers/"
         "outputs/bigeye_level13_initial_numbers_diagnostics.txt\n";
  std::cout
      << "wrote:      "
         "examples/NMFS/pifsc_bigeye_tuna/level13_estimated_initial_numbers/"
         "outputs/bigeye_level13_initial_numbers_diagnostics.csv\n";
  ...
  std::cout
      << "wrote:      "
         "examples/NMFS/pifsc_bigeye_tuna/level13_estimated_initial_numbers/"
         "outputs/bigeye_level13_objective_consistency_check.txt\n";
  std::cout
      << "wrote:      "
         "examples/NMFS/pifsc_bigeye_tuna/level13_estimated_initial_numbers/"
         "outputs/bigeye_level13_objective_consistency_check.csv\n";
