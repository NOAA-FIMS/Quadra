...
int main() {
  const std::string input_path =
      "examples/NMFS/pifsc_bigeye_tuna/level8_tuna_weight_at_age/data/"
      "synthetic_bigeye_level8_tuna_weight_at_age_observations.csv";
  ...
  pifsc_bigeye_tuna::write_recruitment_diagnostics(
      ...
      "bigeye_level8_recruitment_diagnostics.txt",
      "examples/NMFS/pifsc_bigeye_tuna/level8_tuna_weight_at_age/outputs/"
      "bigeye_level8_recruitment_diagnostics.csv",
      objective, fit);

  pifsc_bigeye_tuna::write_longline_slope_geometry_scan(
      "examples/NMFS/pifsc_bigeye_tuna/level8_tuna_weight_at_age/outputs/"
      "bigeye_level8_longline_slope_geometry_scan.txt",
      "examples/NMFS/pifsc_bigeye_tuna/level8_tuna_weight_at_age/outputs/"
      "bigeye_level8_longline_slope_geometry_scan.csv",
      objective, params, fit, opts);

  pifsc_bigeye_tuna::write_safe_fixed_effect_wiggle_diagnostics(
      "examples/NMFS/pifsc_bigeye_tuna/level8_tuna_weight_at_age/outputs/"
      "bigeye_level8_safe_fixed_effect_wiggle_diagnostics.txt",
      "examples/NMFS/pifsc_bigeye_tuna/level8_tuna_weight_at_age/outputs/"
      "bigeye_level8_safe_fixed_effect_wiggle_diagnostics.csv",
      objective, params, fit, opts);
