...
int main()
{
...

    {
      ...
      std::ofstream out(
          "examples/NMFS/pifsc_bigeye_tuna/level15_fixed_m045_best_diagnostic/outputs/"
    ...
    pifsc_bigeye_tuna::write_level13_initial_numbers_diagnostics(
        ...
        fit);
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level15_fixed_m045_best_diagnostic/outputs/bigeye_level15_initial_numbers_diagnostics.txt\n";
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level15_fixed_m045_best_diagnostic/outputs/bigeye_level15_initial_numbers_diagnostics.csv\n";
  ...
  std::cout << "wrote:      "
    ...
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level15_fixed_m045_best_diagnostic/outputs/bigeye_level15_objective_consistency_check.txt\n";
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level15_fixed_m045_best_diagnostic/outputs/bigeye_level15_objective_consistency_check.csv\n";
    ...
    pifsc_bigeye_tuna::write_level15_age_comp_residual_diagnostics(
        ...
        objective,
        fit);
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level15_fixed_m045_best_diagnostic/outputs/bigeye_level15_age_comp_residual_diagnostics.txt\n";
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level15_fixed_m045_best_diagnostic/outputs/bigeye_level15_age_comp_residual_diagnostics.csv\n";
