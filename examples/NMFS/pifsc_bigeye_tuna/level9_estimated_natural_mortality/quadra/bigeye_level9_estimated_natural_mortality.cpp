...
int main()
{
  ...
  std::cout << "wrote:      "
    ...
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level9_estimated_natural_mortality/outputs/bigeye_level9_objective_consistency_check.txt\n";
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level9_estimated_natural_mortality/outputs/bigeye_level9_objective_consistency_check.csv\n";
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level9_estimated_natural_mortality/outputs/bigeye_level9_fixed_effect_geometry_report.txt\n";
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level9_estimated_natural_mortality/outputs/bigeye_level9_fixed_effect_geometry_report.csv\n";
