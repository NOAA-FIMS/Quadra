...
#include "../diagnostics/bigeye_level9_fixed_effect_geometry.hpp"
...
int main() {
  const std::string input_path =
      "examples/NMFS/pifsc_bigeye_tuna/level9_estimated_natural_mortality/data/"
      "synthetic_bigeye_level9_estimated_natural_mortality_observations.csv";
  ...
  params.add({"log_r0", std::log(1200.0), quadra::ParameterTransform::Identity,
              false});
  params.add(
      {"log_m", std::log(0.18), quadra::ParameterTransform::Identity, false});
...

  {
    ...
    std::ofstream out("examples/NMFS/pifsc_bigeye_tuna/"
                      "level9_estimated_natural_mortality/outputs/"
                      "bigeye_level9_objective_consistency_check.csv");
    if (!out) {
    ...
    std::ofstream txt("examples/NMFS/pifsc_bigeye_tuna/"
                      "level9_estimated_natural_mortality/outputs/"
                      "bigeye_level9_objective_consistency_check.txt");
    if (!txt) {
      throw std::runtime_error(
  ...
  pifsc_bigeye_tuna::write_recruitment_diagnostics(
      "examples/NMFS/pifsc_bigeye_tuna/level9_estimated_natural_mortality/"
      "outputs/"
      "bigeye_level9_recruitment_diagnostics.txt",
      "examples/NMFS/pifsc_bigeye_tuna/level9_estimated_natural_mortality/"
      "outputs/"
      "bigeye_level9_recruitment_diagnostics.csv",
      objective, fit);

  pifsc_bigeye_tuna::write_longline_slope_geometry_scan(
      "examples/NMFS/pifsc_bigeye_tuna/level9_estimated_natural_mortality/"
      "outputs/"
      "bigeye_level9_longline_slope_geometry_scan.txt",
      "examples/NMFS/pifsc_bigeye_tuna/level9_estimated_natural_mortality/"
      "outputs/"
      "bigeye_level9_longline_slope_geometry_scan.csv",
      objective, params, fit, opts);

  pifsc_bigeye_tuna::write_safe_fixed_effect_wiggle_diagnostics(
      "examples/NMFS/pifsc_bigeye_tuna/level9_estimated_natural_mortality/"
      "outputs/"
      "bigeye_level9_safe_fixed_effect_wiggle_diagnostics.txt",
      "examples/NMFS/pifsc_bigeye_tuna/level9_estimated_natural_mortality/"
      "outputs/"
      "bigeye_level9_safe_fixed_effect_wiggle_diagnostics.csv",
      objective, params, fit, opts);
  ...
  std::cout
      << "wrote:      "
         "examples/NMFS/pifsc_bigeye_tuna/level9_estimated_natural_mortality/"
         "outputs/bigeye_level9_objective_consistency_check.txt\n";
  std::cout
      << "wrote:      "
         "examples/NMFS/pifsc_bigeye_tuna/level9_estimated_natural_mortality/"
         "outputs/bigeye_level9_objective_consistency_check.csv\n";
  std::cout
      << "wrote:      "
         "examples/NMFS/pifsc_bigeye_tuna/level9_estimated_natural_mortality/"
         "outputs/bigeye_level9_fixed_effect_geometry_report.txt\n";
  std::cout
      << "wrote:      "
         "examples/NMFS/pifsc_bigeye_tuna/level9_estimated_natural_mortality/"
         "outputs/bigeye_level9_fixed_effect_geometry_report.csv\n";
