...
int main() {
  const std::string input_path =
      "examples/NMFS/pifsc_bigeye_tuna/level16_purse_seine_age_selectivity/"
      "data/"
...

  {
    ...
    std::ofstream out("examples/NMFS/pifsc_bigeye_tuna/"
                      "level16_purse_seine_age_selectivity/outputs/"
  ...
  std::cout
      << "wrote:      "
         "examples/NMFS/pifsc_bigeye_tuna/level16_purse_seine_age_selectivity/"
         "outputs/bigeye_level16_initial_numbers_diagnostics.txt\n";
  std::cout
      << "wrote:      "
         "examples/NMFS/pifsc_bigeye_tuna/level16_purse_seine_age_selectivity/"
         "outputs/bigeye_level16_initial_numbers_diagnostics.csv\n";
  ...
  std::cout
      << "wrote:      "
         "examples/NMFS/pifsc_bigeye_tuna/level16_purse_seine_age_selectivity/"
         "outputs/bigeye_level16_objective_consistency_check.txt\n";
  std::cout
      << "wrote:      "
         "examples/NMFS/pifsc_bigeye_tuna/level16_purse_seine_age_selectivity/"
         "outputs/bigeye_level16_objective_consistency_check.csv\n";
  ...
  std::cout
      << "wrote:      "
         "examples/NMFS/pifsc_bigeye_tuna/level16_purse_seine_age_selectivity/"
         "outputs/bigeye_level16_age_comp_residual_diagnostics.txt\n";
  std::cout
      << "wrote:      "
         "examples/NMFS/pifsc_bigeye_tuna/level16_purse_seine_age_selectivity/"
         "outputs/bigeye_level16_age_comp_residual_diagnostics.csv\n";
  ...
  std::cout
      << "wrote:      "
         "examples/NMFS/pifsc_bigeye_tuna/level16_purse_seine_age_selectivity/"
         "outputs/bigeye_level16_purse_seine_prediction_decomposition.txt\n";
  std::cout
      << "wrote:      "
         "examples/NMFS/pifsc_bigeye_tuna/level16_purse_seine_age_selectivity/"
         "outputs/bigeye_level16_purse_seine_prediction_decomposition.csv\n";
