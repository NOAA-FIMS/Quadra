...
#include "../diagnostics/bigeye_level20_parameter_sanity_diagnostics.hpp"
...
inline double read_env_double_level23(const char *name, double fallback) {
...
int main()
{
  const double level23_ll_sel_sigma =
      read_env_double_level23("LEVEL23_LL_SEL_SIGMA", 1.75);
  const double level23_ll_smooth_lambda =
      read_env_double_level23("LEVEL23_LL_SMOOTH_LAMBDA", 0.0);
  std::cout << "longline_selectivity_sigma: " << level23_ll_sel_sigma << "\n";
  std::cout << "longline_selectivity_smooth_lambda: " << level23_ll_smooth_lambda << "\n";

    const std::string input_path =
        "examples/NMFS/pifsc_bigeye_tuna/level23_longline_selectivity_smoothness_scan/data/"
        "synthetic_bigeye_level23_longline_selectivity_smoothness_scan_observations.csv";
...

    {
      ...
      std::ofstream out(
          "examples/NMFS/pifsc_bigeye_tuna/level23_longline_selectivity_smoothness_scan/outputs/"
          "bigeye_level23_objective_consistency_check.csv");
      if (!out) {
      ...
      std::ofstream txt(
          "examples/NMFS/pifsc_bigeye_tuna/level23_longline_selectivity_smoothness_scan/outputs/"
          "bigeye_level23_objective_consistency_check.txt");
      if (!txt) {
    ...
    pifsc_bigeye_tuna::write_level13_initial_numbers_diagnostics(
        "examples/NMFS/pifsc_bigeye_tuna/level23_longline_selectivity_smoothness_scan/outputs/"
        "bigeye_level23_initial_numbers_diagnostics.txt",
        "examples/NMFS/pifsc_bigeye_tuna/level23_longline_selectivity_smoothness_scan/outputs/"
        "bigeye_level23_initial_numbers_diagnostics.csv",
        fit);
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level23_longline_selectivity_smoothness_scan/outputs/bigeye_level23_initial_numbers_diagnostics.txt\n";
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level23_longline_selectivity_smoothness_scan/outputs/bigeye_level23_initial_numbers_diagnostics.csv\n";

    pifsc_bigeye_tuna::write_recruitment_diagnostics(
        "examples/NMFS/pifsc_bigeye_tuna/level23_longline_selectivity_smoothness_scan/outputs/"
        "bigeye_level23_recruitment_diagnostics.txt",
        "examples/NMFS/pifsc_bigeye_tuna/level23_longline_selectivity_smoothness_scan/outputs/"
        "bigeye_level23_recruitment_diagnostics.csv",
        objective, fit);

    pifsc_bigeye_tuna::write_longline_slope_geometry_scan(
        "examples/NMFS/pifsc_bigeye_tuna/level23_longline_selectivity_smoothness_scan/outputs/"
        "bigeye_level23_longline_slope_geometry_scan.txt",
        "examples/NMFS/pifsc_bigeye_tuna/level23_longline_selectivity_smoothness_scan/outputs/"
        "bigeye_level23_longline_slope_geometry_scan.csv",
        objective, params, fit, opts);

    pifsc_bigeye_tuna::write_safe_fixed_effect_wiggle_diagnostics(
        "examples/NMFS/pifsc_bigeye_tuna/level23_longline_selectivity_smoothness_scan/outputs/"
        "bigeye_level23_safe_fixed_effect_wiggle_diagnostics.txt",
        "examples/NMFS/pifsc_bigeye_tuna/level23_longline_selectivity_smoothness_scan/outputs/"
        "bigeye_level23_safe_fixed_effect_wiggle_diagnostics.csv",
        objective, params, fit, opts);
  ...
  std::cout << "wrote:      "
    ...
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level23_longline_selectivity_smoothness_scan/outputs/bigeye_level23_objective_consistency_check.txt\n";
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level23_longline_selectivity_smoothness_scan/outputs/bigeye_level23_objective_consistency_check.csv\n";


    pifsc_bigeye_tuna::write_level15_age_comp_residual_diagnostics(
        "examples/NMFS/pifsc_bigeye_tuna/level23_longline_selectivity_smoothness_scan/outputs/"
        "bigeye_level23_age_comp_residual_diagnostics.txt",
        "examples/NMFS/pifsc_bigeye_tuna/level23_longline_selectivity_smoothness_scan/outputs/"
        "bigeye_level23_age_comp_residual_diagnostics.csv",
        objective,
        fit);
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level23_longline_selectivity_smoothness_scan/outputs/bigeye_level23_age_comp_residual_diagnostics.txt\n";
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level23_longline_selectivity_smoothness_scan/outputs/bigeye_level23_age_comp_residual_diagnostics.csv\n";

    pifsc_bigeye_tuna::write_level16_purse_seine_prediction_decomposition(
        "examples/NMFS/pifsc_bigeye_tuna/level23_longline_selectivity_smoothness_scan/outputs/"
        "bigeye_level23_purse_seine_prediction_decomposition.txt",
        "examples/NMFS/pifsc_bigeye_tuna/level23_longline_selectivity_smoothness_scan/outputs/"
        "bigeye_level23_purse_seine_prediction_decomposition.csv",
        objective, fit);
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level23_longline_selectivity_smoothness_scan/outputs/bigeye_level23_purse_seine_prediction_decomposition.txt\n";
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level23_longline_selectivity_smoothness_scan/outputs/bigeye_level23_purse_seine_prediction_decomposition.csv\n";

    pifsc_bigeye_tuna::write_level18_longline_prediction_decomposition(
        "examples/NMFS/pifsc_bigeye_tuna/level23_longline_selectivity_smoothness_scan/outputs/"
        "bigeye_level23_longline_prediction_decomposition.txt",
        "examples/NMFS/pifsc_bigeye_tuna/level23_longline_selectivity_smoothness_scan/outputs/"
        "bigeye_level23_longline_prediction_decomposition.csv",
        objective, fit);
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level23_longline_selectivity_smoothness_scan/outputs/bigeye_level23_longline_prediction_decomposition.txt\n";
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level23_longline_selectivity_smoothness_scan/outputs/bigeye_level23_longline_prediction_decomposition.csv\n";


    pifsc_bigeye_tuna::write_level23_parameter_sanity_diagnostics(
        "examples/NMFS/pifsc_bigeye_tuna/level23_longline_selectivity_smoothness_scan/outputs/"
        "bigeye_level23_parameter_sanity_diagnostics.txt",
        "examples/NMFS/pifsc_bigeye_tuna/level23_longline_selectivity_smoothness_scan/outputs/"
        "bigeye_level23_parameter_sanity_diagnostics.csv",
        fit);
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level23_longline_selectivity_smoothness_scan/outputs/bigeye_level23_parameter_sanity_diagnostics.txt\n";
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level23_longline_selectivity_smoothness_scan/outputs/bigeye_level23_parameter_sanity_diagnostics.csv\n";
