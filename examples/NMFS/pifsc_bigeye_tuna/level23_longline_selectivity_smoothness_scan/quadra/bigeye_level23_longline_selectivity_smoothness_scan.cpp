...
int main() {
  ...
  std::cout << "longline_selectivity_smooth_lambda: "
            << level23_ll_smooth_lambda << "\n";

  const std::string input_path =
      "examples/NMFS/pifsc_bigeye_tuna/"
      "level23_longline_selectivity_smoothness_scan/data/"
      "synthetic_bigeye_level23_longline_selectivity_smoothness_scan_"
      "observations.csv";
...

  {
    ...
    std::ofstream out("examples/NMFS/pifsc_bigeye_tuna/"
                      "level23_longline_selectivity_smoothness_scan/outputs/"
