...
struct BigeyeReportPaths {
  std::string summary = "examples/NMFS/pifsc_bigeye_tuna/level1_multifleet/"
                        "outputs/bigeye_level1_fit_summary.csv";
  std::string trajectory = "examples/NMFS/pifsc_bigeye_tuna/level1_multifleet/"
                           "outputs/bigeye_level1_fitted_trajectory.csv";
  ...
  std::string selectivity = "examples/NMFS/pifsc_bigeye_tuna/level1_multifleet/"
                            "outputs/bigeye_level1_selectivity_at_age.csv";
  std::string recruitment_deviations =
      "examples/NMFS/pifsc_bigeye_tuna/level1_multifleet/outputs/"
      "bigeye_level1_recruitment_deviations.csv";
