...
int main()
{
    ...
    const auto observations = read_multifleet_observations_as_aggregate(input_path);
    ...
    std::cout
        << "PIFSC bigeye-tuna-style Level 1 multi-fleet Quadra Laplace recruitment-deviation fit\n";
