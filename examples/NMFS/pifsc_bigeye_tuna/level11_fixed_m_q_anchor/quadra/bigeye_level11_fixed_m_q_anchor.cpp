...
int main() {
  const std::string input_path =
      "examples/NMFS/pifsc_bigeye_tuna/level11_fixed_m_q_anchor/data/"
      "synthetic_bigeye_level11_fixed_m_q_anchor_observations.csv";
...

  {
    ...
    std::ofstream out(
        "examples/NMFS/pifsc_bigeye_tuna/level11_fixed_m_q_anchor/outputs/"
        "bigeye_level11_objective_consistency_check.csv");
    if (!out) {
    ...
    std::ofstream txt(
        "examples/NMFS/pifsc_bigeye_tuna/level11_fixed_m_q_anchor/outputs/"
        "bigeye_level11_objective_consistency_check.txt");
    if (!txt) {
      throw std::runtime_error(
  ...
  pifsc_bigeye_tuna::write_recruitment_diagnostics(
      "examples/NMFS/pifsc_bigeye_tuna/level11_fixed_m_q_anchor/outputs/"
      "bigeye_level11_recruitment_diagnostics.txt",
      "examples/NMFS/pifsc_bigeye_tuna/level11_fixed_m_q_anchor/outputs/"
      "bigeye_level11_recruitment_diagnostics.csv",
      objective, fit);

  pifsc_bigeye_tuna::write_longline_slope_geometry_scan(
      "examples/NMFS/pifsc_bigeye_tuna/level11_fixed_m_q_anchor/outputs/"
      "bigeye_level11_longline_slope_geometry_scan.txt",
      "examples/NMFS/pifsc_bigeye_tuna/level11_fixed_m_q_anchor/outputs/"
      "bigeye_level11_longline_slope_geometry_scan.csv",
      objective, params, fit, opts);

  pifsc_bigeye_tuna::write_safe_fixed_effect_wiggle_diagnostics(
      "examples/NMFS/pifsc_bigeye_tuna/level11_fixed_m_q_anchor/outputs/"
      "bigeye_level11_safe_fixed_effect_wiggle_diagnostics.txt",
      "examples/NMFS/pifsc_bigeye_tuna/level11_fixed_m_q_anchor/outputs/"
      "bigeye_level11_safe_fixed_effect_wiggle_diagnostics.csv",
      objective, params, fit, opts);
  ...
  std::cout << "wrote:      "
               "examples/NMFS/pifsc_bigeye_tuna/level11_fixed_m_q_anchor/"
               "outputs/bigeye_level11_objective_consistency_check.txt\n";
  std::cout << "wrote:      "
               "examples/NMFS/pifsc_bigeye_tuna/level11_fixed_m_q_anchor/"
               "outputs/bigeye_level11_objective_consistency_check.csv\n";
