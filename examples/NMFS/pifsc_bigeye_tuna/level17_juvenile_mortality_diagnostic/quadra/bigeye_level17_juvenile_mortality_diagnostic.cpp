...
int main()
{
    const std::string input_path =
        "examples/NMFS/pifsc_bigeye_tuna/level17_juvenile_mortality_diagnostic/data/"
        "synthetic_bigeye_level17_juvenile_mortality_diagnostic_observations.csv";
    ...
    params.add({"log_juvenile_m_multiplier", 0.0,
                quadra::ParameterTransform::Identity, false});
...

    {
      ...
      std::ofstream out(
          "examples/NMFS/pifsc_bigeye_tuna/level17_juvenile_mortality_diagnostic/outputs/"
          "bigeye_level17_objective_consistency_check.csv");
      if (!out) {
      ...
      std::ofstream txt(
          "examples/NMFS/pifsc_bigeye_tuna/level17_juvenile_mortality_diagnostic/outputs/"
          "bigeye_level17_objective_consistency_check.txt");
      if (!txt) {
    ...
    pifsc_bigeye_tuna::write_level13_initial_numbers_diagnostics(
        "examples/NMFS/pifsc_bigeye_tuna/level17_juvenile_mortality_diagnostic/outputs/"
        "bigeye_level17_initial_numbers_diagnostics.txt",
        "examples/NMFS/pifsc_bigeye_tuna/level17_juvenile_mortality_diagnostic/outputs/"
        "bigeye_level17_initial_numbers_diagnostics.csv",
        fit);
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level17_juvenile_mortality_diagnostic/outputs/bigeye_level17_initial_numbers_diagnostics.txt\n";
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level17_juvenile_mortality_diagnostic/outputs/bigeye_level17_initial_numbers_diagnostics.csv\n";

    pifsc_bigeye_tuna::write_recruitment_diagnostics(
        "examples/NMFS/pifsc_bigeye_tuna/level17_juvenile_mortality_diagnostic/outputs/"
        "bigeye_level17_recruitment_diagnostics.txt",
        "examples/NMFS/pifsc_bigeye_tuna/level17_juvenile_mortality_diagnostic/outputs/"
        "bigeye_level17_recruitment_diagnostics.csv",
        objective, fit);

    pifsc_bigeye_tuna::write_longline_slope_geometry_scan(
        "examples/NMFS/pifsc_bigeye_tuna/level17_juvenile_mortality_diagnostic/outputs/"
        "bigeye_level17_longline_slope_geometry_scan.txt",
        "examples/NMFS/pifsc_bigeye_tuna/level17_juvenile_mortality_diagnostic/outputs/"
        "bigeye_level17_longline_slope_geometry_scan.csv",
        objective, params, fit, opts);

    pifsc_bigeye_tuna::write_safe_fixed_effect_wiggle_diagnostics(
        "examples/NMFS/pifsc_bigeye_tuna/level17_juvenile_mortality_diagnostic/outputs/"
        "bigeye_level17_safe_fixed_effect_wiggle_diagnostics.txt",
        "examples/NMFS/pifsc_bigeye_tuna/level17_juvenile_mortality_diagnostic/outputs/"
        "bigeye_level17_safe_fixed_effect_wiggle_diagnostics.csv",
        objective, params, fit, opts);
  ...
  std::cout << "wrote:      "
    ...
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level17_juvenile_mortality_diagnostic/outputs/bigeye_level17_objective_consistency_check.txt\n";
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level17_juvenile_mortality_diagnostic/outputs/bigeye_level17_objective_consistency_check.csv\n";


    pifsc_bigeye_tuna::write_level15_age_comp_residual_diagnostics(
        "examples/NMFS/pifsc_bigeye_tuna/level17_juvenile_mortality_diagnostic/outputs/"
        "bigeye_level17_age_comp_residual_diagnostics.txt",
        "examples/NMFS/pifsc_bigeye_tuna/level17_juvenile_mortality_diagnostic/outputs/"
        "bigeye_level17_age_comp_residual_diagnostics.csv",
        objective,
        fit);
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level17_juvenile_mortality_diagnostic/outputs/bigeye_level17_age_comp_residual_diagnostics.txt\n";
    std::cout << "wrote:      examples/NMFS/pifsc_bigeye_tuna/level17_juvenile_mortality_diagnostic/outputs/bigeye_level17_age_comp_residual_diagnostics.csv\n";
