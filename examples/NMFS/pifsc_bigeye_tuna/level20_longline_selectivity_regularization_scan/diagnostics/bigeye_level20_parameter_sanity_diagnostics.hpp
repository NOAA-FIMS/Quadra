...
inline void write_level20_parameter_sanity_diagnostics(
    ...
    const quadra::OptResult &fit)
{
  ...
  if (!txt || !csv) {
    throw std::runtime_error("Cannot write Level 20 parameter sanity diagnostics");
  }
  ...
  txt << "Level 20 Parameter Sanity Diagnostics\n";
  txt << "=====================================\n\n";
  txt << "Purpose\n";
  txt << "-------\n";
  txt << "Check whether Level 20 improved the age-composition fit by creating\n";
  ...
  txt << "departures, indicate that Level 20 may be fitting composition data by\n";
...
using pifsc_bigeye_tuna::write_level20_parameter_sanity_diagnostics;
