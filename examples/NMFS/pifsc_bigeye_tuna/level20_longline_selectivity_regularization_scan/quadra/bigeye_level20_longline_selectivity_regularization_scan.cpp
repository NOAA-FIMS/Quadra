...
int main() {
  const std::string input_path =
      ...
      "level20_longline_selectivity_regularization_scan/data/"
      "synthetic_bigeye_level20_longline_selectivity_regularization_scan_"
      "observations.csv";
...

  {
    ...
    std::ofstream out(
        "examples/NMFS/pifsc_bigeye_tuna/"
        "level20_longline_selectivity_regularization_scan/outputs/"
