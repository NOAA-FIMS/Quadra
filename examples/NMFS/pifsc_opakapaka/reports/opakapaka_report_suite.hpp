...
inline void write_opakapaka_report_suite(
    Model &model, quadra::ParameterVector &params, quadra::LaplaceOptions &opts,
    const quadra::OptResult &fit, const std::vector<Observation> &data,
...

  {
    ...
    const Eigen::MatrixXd biomass_cov_core =
        quadra::uncertainty::lognormal_delta_covariance(log_b_core, log_b_cov);
  ...
  write_opakapaka_reference_points_csv(
      "examples/NMFS/pifsc_opakapaka/outputs/reference_points.csv", fit, data);
