...
class DemoModel : public quadra::QuadraModel<DemoModel> {
public:
  DemoModel(std::vector<double> y) : y_m(std::move(y)) {
...
int main() {
  ...
  auto result = quadra::evaluate_laplace_implicit_derivatives(
