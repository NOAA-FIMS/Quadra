...
int main(int argc, char **argv) {
  ...
  std::cout << "Quadra no-plus age-structured flat-band timing diagnostic\n";
  std::cout << "reps per n = " << reps << ", ages = " << n_ages << "\n\n";

  std::cout << std::setw(8) << "n" << std::setw(14) << "objective"
            << std::setw(14) << "avg_ms" << std::setw(14) << "opt_ms"
            << std::setw(14) << "eval_ms" << std::setw(14) << "logdet_ms"
            << std::setw(10) << "newton" << std::setw(10) << "evals"
            << std::setw(10) << "ls_eval" << std::setw(10) << "nnz" << "\n";
  ...
  for (const int n : lengths) {
    ...
    std::cout << std::setw(8) << n << std::setw(14) << last.marginal
              << std::setw(14) << avg_ms << std::setw(14) << last.optimize_ms
              << std::setw(14) << last.final_eval_ms << std::setw(14)
              << last.logdet_ms << std::setw(10) << last.newton_iterations
              << std::setw(10) << last.eval_all_calls << std::setw(10)
              << last.line_search_eval_calls << std::setw(10) << last.nnz
              << "\n";
  }
