...
int main(int argc, char **argv) {
  ...
  std::cout << "Quadra no-plus age-structured flat-band warm-start benchmark\n";
  std::cout << "reps per n = " << reps << ", ages = " << n_ages << "\n\n";

  std::cout << std::setw(8) << "n" << std::setw(14) << "objective"
            << std::setw(14) << "cold_ms" << std::setw(14) << "cached_ms"
            << std::setw(14) << "warm_ms" << std::setw(14) << "grad_norm"
            << std::setw(10) << "nnz" << "\n";
  ...
  for (const int n : lengths) {
    ...
    std::cout << std::setw(8) << n << std::setw(14) << last.marginal
              << std::setw(14) << cold_ms << std::setw(14) << cached_ms
              << std::setw(14) << warm_ms << std::setw(14) << last.grad_norm
