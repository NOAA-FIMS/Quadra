...
mkdir -p "$BASE/level09_optimizer_check"

cat > "$BASE/level09_optimizer_check/bigeye_v2_level09_optimizer_check.cpp" <<'CPP'
...
cat > run_bigeye_v2_level09_optimizer_check.sh <<'SH'
#!/usr/bin/env bash
set -euo pipefail
...
chmod +x run_bigeye_v2_level09_optimizer_check.sh

echo "created Bigeye v2 Level09 optimizer check"
