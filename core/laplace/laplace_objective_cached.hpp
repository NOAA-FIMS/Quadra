...
inline double cached_laplace_logdet(
...
inline LaplaceObjectiveResult evaluate_laplace_objective_cached(
    ...
    try {
        result.log_det_hessian_m =
            cached_laplace_logdet(
                result.hessian_random_m,
                cache_state,
                options
            );
        ...
        result.message_m =
            std::string("Cached logdet failed: ") + e.what();
    }
...
inline LaplaceObjectiveResult evaluate_laplace_objective_cached(
    ...
    return evaluate_laplace_objective_cached(
        model,
        fixed,
        random_initial,
