...
LaplaceEvaluationResult evaluate_laplace_objective_and_gradient(
    ...
    auto workspace =
        make_exact_laplace_iteration_workspace(
    ...
    const Eigen::VectorXd gradient =
        workspace.gradient(joint_envelope_gradient);
    ...
    out.logdet_gradient_contribution =
        workspace.logdet_gradient_contribution();
