...
inline JointOnlyExactLBFGSResult optimize_joint_only_exact_lbfgs(
    ...
    const JointOnlyExactLBFGSOptions& options =
        JointOnlyExactLBFGSOptions()
) {
    ...
    JointOnlyExactGradientResult current =
        evaluate_joint_only_exact_gradient(
            model,
            theta,
            random_start,
            partition,
...
inline JointOnlyExactLBFGSResult optimize_joint_only_exact_lbfgs(
    ...
    return optimize_joint_only_exact_lbfgs(
        model,
        theta_initial,
        random_initial,
