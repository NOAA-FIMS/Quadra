...
mkdir -p "$BASE/19_generated_cycle_equivalence_caa"

cat > "$BASE/19_generated_cycle_equivalence_caa/bigeye_v2_19_generated_cycle_equivalence_caa_check.cpp" <<'CPP'
...
echo "installed generated cycle equivalence check"
echo
echo "Run:"
echo "  ./run_bigeye_v2_19_generated_cycle_equivalence_caa_check.sh"
