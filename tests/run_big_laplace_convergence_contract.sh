...
if ! make run-big-examples CXXFLAGS="-std=c++17 -O3 -flto -I. -I./external/eigen -I./external/eigen/Eigen -I./external/had -I./external/LBFGSpp/include" > "$BUILD_LOG" 2>&1; then
