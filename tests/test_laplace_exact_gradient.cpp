...
int main() {
  ...
  auto exact = quadra::evaluate_laplace_exact_gradient(
      model, fixed, u0, model.parameters(), exact_options);
  ...
  auto fd = quadra::evaluate_laplace_fixed_gradient(
      model, fixed, u0, model.parameters(), fd_options);
