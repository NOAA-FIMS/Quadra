...
struct has_member_set_value<
    T, std::void_t<decltype(std::declval<T &>().set_value(0.0))>>
    : std::true_type {};
...
struct has_member_setValue<
    T, std::void_t<decltype(std::declval<T &>().setValue(0.0))>>
    : std::true_type {};
...
template <typename T>
struct has_assign_from_double<T,
...
struct has_value_member_assign<
    T, std::void_t<decltype(std::declval<T &>().value = 0.0)>>
    : std::true_type {};
...
struct has_value_m_member_assign<
    T, std::void_t<decltype(std::declval<T &>().value_m = 0.0)>>
    : std::true_type {};
...
struct has_val_member_assign<
    T, std::void_t<decltype(std::declval<T &>().val = 0.0)>> : std::true_type {
};
...
struct has_val_m_member_assign<
    T, std::void_t<decltype(std::declval<T &>().val_m = 0.0)>>
    : std::true_type {};
...
template <typename T>
struct has_graph_member<T, std::void_t<decltype(std::declval<T &>().graph)>>
    : std::true_type {};
...
template <typename T>
struct has_graph_m_member<T, std::void_t<decltype(std::declval<T &>().graph_m)>>
    : std::true_type {};
...
struct has_context_set_independent_values<
    T, std::void_t<decltype(std::declval<T &>().set_independent_values(
           std::declval<std::vector<double>>()))>> : std::true_type {};
...
struct has_context_set_values<
    T, std::void_t<decltype(std::declval<T &>().set_values(
           std::declval<std::vector<double>>()))>> : std::true_type {};
