...
./inspect_bigeye_level9_report_index_fix.sh

echo
echo "== O3 build Bigeye Level 9 report index fix =="
...
c++ -std=c++17 -O3 \
  ...
  -o build/examples/pifsc_bigeye_level9_report_index_fix_check

echo
echo "== Run Bigeye Level 9 report index fix =="
./build/examples/pifsc_bigeye_level9_report_index_fix_check
